...
html {
    background: #f7f7f8;text - align: center;text - rendering: optimizeLegibility;font - family: -apple - system,
    BlinkMacSystemFont,
    "Segoe UI",
    Helvetica,
    Arial,
    ...
    "Apple Color Emoji",
    "Segoe UI Emoji",
    "Segoe UI Symbol";line - height: 1.5;word - wrap: break -word; - webkit - box - sizing: border - box;box - sizing: border - box;background: #eeeeee;color: #333333}.Content,body{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}body{padding:32px 8px;margin:0}.Content{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;margin:32px;-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1}@media screen and (max-width:768px){.Content{padding:0;margin:32px 0}}.AuthBox{max-width:100%;background:# fff;border: 1 px solid #eaebeb; - webkit - box - shadow: 0 4 px 8 px rgba(146, 151, 155, .15);box - shadow: 0 4 px 8 px rgba(146, 151, 155, .15);padding - top: 2 em;width: 36 em
}.base_AccessLogo {
    margin - bottom: 1 em
}.base_TeamsLogo {
    padding - top: 1 em;
...
@media only screen and(max - width: 420 px) and(pointer: coarse) {
    .base_AccessLogo {
        margin - top: 1 em
    }.base_TeamsLogo {
        padding: 1 em 0
    ...
    border - radius: 5 px 0 .5 em .5 em;
    background: rgba(0, 0, 0, .03);
    border - top: 1 px solid rgba(0, 0, 0, .15)
    ...
    border: 0;border - radius: 5 px;margin - bottom: 2 rem
}.ErrorBlock, .ErrorBlock - icon {
    display: -webkit - box;display: -ms - flexbox;display: flex
}.ErrorBlock - icon {
    width: 2.25 em;height: 2.25 em;margin - right: 1.25 em
}.ErrorBlock - icon > svg {
    ...
    align - items: center; - ms - flex - wrap: inherit;
    flex - wrap: inherit;
    padding - left: .5 em
}.Button.Button - is - auth.Button - auth - service - icon {
    width: 2.8 em;height: auto;padding: .5 em;color: #1d1f20;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.Button.Button-is-auth .Button-auth-service-icon>svg{fill:currentColor;display:block;min-width:25px;width:25px;height:25px}.Button.Button-uses-org-theme-accent-color{margin:0;max-width:unset}.AuthBox-messages{max-width:36em}.Button.Button-is-auth .Button-auth-service-icon,.Message,.RayID{display:-webkit-box;display:-ms-flexbox;display:flex}.Message{-webkit-box-align:center;-ms-flex-align:center;align-items:center;font-size:.9em;overflow:hidden;margin-bottom:1em;border-radius:5px;padding:.5em 1em;text-align:left}.Message svg{height:1em;width:1em;margin-right:.5em}.Message.Message-is-warning{background:# fcf0f2;color: #711423;border:1px solid # f3bac3
}.Message.Message - is - success {
    background: #a6eac9;color: #1c422b;border:1px solid # b0ddc2
}.RayID {
    padding: 0;text - align: center;background: #dfbd9f
}.RayID.RayID - Title, .RayID.RayID - Value {
    -webkit - box - flex: 0; - ms - flex: 0 0 auto;
    flex: 0 0 auto;
    padding: 1 em;
    display: inline - block
}.RayID.RayID - Value {
    background: #e7c9af; - webkit - box - flex: 1; - ms - flex: 1 1 auto;flex: 1 1 auto;font - family: Monaco,
    "Bitstream Vera Sans Mono",
    "Lucida Console",
    Terminal,
    monospace
}.StandardInput {
    position: relative; - webkit - user - select: auto; - moz - user - select: auto; - ms - user - select: auto;user - select: auto; - webkit - appearance: none; - moz - appearance: none;appearance: none;display: inline - block;text - align: left;font: inherit;color: "#333333";padding: .5 em 1 em;border: 1 px solid #cacaca;margin: 0;border - radius: 5 px
}.StandardInput: focus {
    outline: 0;border - color: #777}.StandardInput.StandardInput-is-block{display:block;font-size:1em;width:100%}.StandardInput.StandardInput-is-code{font-family:Monaco,"Bitstream Vera Sans Mono","Lucida Console",Terminal,monospace}.StandardInput.StandardInput-is-entry-code{font-size:20px}.StandardInput:-moz-placeholder,.StandardInput::-webkit-input-placeholder{font-family:inherit}.OrgAvatarLink{display:block;text-decoration:none;color:inherit}.OrgAvatarLink-logo img{margin-bottom:.5em}.App-name,.OrgAvatarLink-title{text-align:center;font-weight:200}.OrgAvatarLink-title{color:# 4e5255;font - size: .8 em
}.App - name {
    font - size: 1.5 em
}
...
script > ! function(e) {
    ...
    function n(e) {
        ...
        function u(e) {
            var r = this;
            this._list = [], null == e || (e instanceof u ? this._list = o(String(e)) : "object" == typeof e && t(e) ? n(e).forEach(function(e) {
                if (!t(e)) throw TypeError();
                var a = n(e);
                if (2 !== a.length) throw TypeError();
                r._list.push({
                    name: String(a[0]),
                    value: String(a[1])
                })
            ...
            }) : ("?" === (e = String(e)).substring(0, 1) && (e = e.substring(1)), this._list = o(e))), this._url_object = null, this._setList = function(e) {
                a || (r._list = e)
            };
            var a = !1;
            this._update_steps = function() {
                a || (a = !0, r._url_object && ("about:" === r._url_object.protocol && -1 !== r._url_object.pathname.indexOf("?") && (r._url_object.pathname = r._url_object.pathname.split("?")[0]), r._url_object.search = i(r._list), a = !1))
            }
        }
        ...
        function c(t, n) {
            ...
            n && (t = function() {
                ...
                try {
                    ...
                    o.href = n, i.getElementsByTagName("head")[0].appendChild(o);
            ...
            var i = function(e) {
                ...
                c = new u(i.search ? i.search.substring(1) : null);
            ...
            function f() {
                c._setList(i.search ? o(i.search.substring(1)) : []), c._update_steps()
            }
        ...
        if (Object.defineProperties(u.prototype, {
            ...
            for (var s in a) a.hasOwnProperty(s) && "function" == typeof a[s] && (c[s] = a[s]);
        e.URL = c, e.URLSearchParams = u
    }(),
    function() {
...
var get = function(t) {
    ...
    addFragmentToURLState = function(t) {
        if (!t) return t;
        var e = new URL(t);
        if (e && "" !== fragment && fragment.length < 100) {
            var a = window.btoa(JSON.stringify({
                    fragment: "#" === fragment[0] ? fragment : "#".concat(fragment)
                })),
                r = e.searchParams.get("state"),
                n = e.searchParams.get("RelayState");
            r ? e.searchParams.set("state", "".concat(r, ".").concat(a)) : n && e.searchParams.set("RelayState", "".concat(n, ".").concat(a))
        }
        return e.toString()
    },
    fragment = window.location.hash || "",
    article = document.querySelector("#data"),
    dset = article.dataset,
    autoRedirectToIdentity = "true" === dset.autoRedirectToIdentity,
    autoRedirectURL = addFragmentToURLState(dset.autoRedirectUrl),
    message = dset.message;
autoRedirectURL && autoRedirectToIdentity && (message || (window.location = autoRedirectURL)); < /script> <
/head>
...
onload = "this.style.display=''" > < /img> <
    ...
    vrchat - net.cloudflareaccess.com <
    /div> <
    /a> <
    div class = "AuthBox-App" >
    <
    div class = "App-name" >
    VRC Dev Frontend React Bundle <
    /div>
    ...
    <
    a class = " Button Button-is-block Button-is-auth js-idp"
data - idp = "Google"
title = "Google"
href = "https:&#x2F;&#x2F;accounts.google.com&#x2F;o&#x2F;oauth2&#x2F;auth?client_id&#x3D;843656276710-vj1jak1ddg3ipku27m4jqkvtq73cr1dm.apps.googleusercontent.com&amp;redirect_uri&#x3D;https%3A%2F%2Fvrchat-net.cloudflareaccess.com%2Fcdn-cgi%2Faccess%2Fcallback&amp;response_type&#x3D;code&amp;state&#x3D;b60ccc7d580a7ec60245320affc6ccfc0f0860546fe400fc8fd718fb1ec90b01.%253D&amp;scope&#x3D;email+profile+openid"
accesskey = "1"
id = "idp1" >
    <
    ...
    div class = "AuthBoxRow--name" > Google < /div> <
    /a> <
    /div> <
    div class = "AuthServiceLogin-row " >
    <
...
data - idp = "Okta"
title = "Okta ・ Okta"
href = "https:&#x2F;&#x2F;vrchat.okta.com&#x2F;oauth2&#x2F;v1&#x2F;authorize?client_id&#x3D;0oaehqfaqaKY3l57q697&amp;redirect_uri&#x3D;https%3A%2F%2Fvrchat-net.cloudflareaccess.com%2Fcdn-cgi%2Faccess%2Fcallback&amp;response_type&#x3D;code&amp;scope&#x3D;openid%20groups%20profile%20email&amp;state&#x3D;95453d89b629306beaef57f15456c4f935d2217aa9664d4956f7ced05482e88e.%253D"
accesskey = "2"
id = "idp2" >
    <
    div class = "Button-auth-service-icon" > < svg viewBox = "0 0 384 384" > < path d = "M192,384 C86,384 0,298 0,192 C0,86 86,0 192,0 C298,0 384,86 384,192 C384,298 298,384 192,384 Z M192,288 C245,288 288,245 288,192 C288,139 245,96 192,96 C139,96 96,139 96,192 C96,245 139,288 192,288 Z" > < /path></svg > < /div> <
    div class = "AuthBoxRow--name" > Okta・ Okta < /div> <
    /a> <
    /div> <
    /div>
