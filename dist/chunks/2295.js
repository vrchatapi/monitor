    ...
    [2295], {
        ...
        42295: (e, t, r) => {
            ...
            const F = function() {
                var e = (0, m.I0)(),
                    t = (0, b.sc)().emailTaken,
                    r = (0, w.s0)(),
                    a = (0, b.ve)("web-test-not-logged-in", {
                        value: "control"
                    }),
                    ...
                    $ = N[0],
                    D = N[1],
                    j = (D.isError, D.error, d.useState(!1)),
                    S = (0, l.Z)(j, 2),
                    P = S[0],
                    Z = S[1],
                    M = d.useState({
                        ...
                        var e = (0, n.Z)(s().mark((function e(r) {
                            ...
                            return s().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (a = r.target.value, n = void 0 === a ? "" : a, A(k(k({}, I), {}, {
                                                value: n
                                            })), "" !== n) {
                                            e.next = 4;
                                            break
                    ...
                    oe = function() {
                        var e = (0, n.Z)(s().mark((function e(t) {
                            return s().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return t.preventDefault(), e.next = 3, O();
                                    case 3:
                                        if (!E.emailVerified) {
                                            e.next = 6;
                                            break
                ...
                return d.createElement(y.Z, {
                    showVRCLogo: !u
                }, d.createElement(h.$4, null, "Email Verification"), d.createElement("div", {
                ...
                }, "Email Verification"), Q.failed && d.createElement("p", {
                ...
                }, "here")), ae && d.createElement(d.Fragment, null, d.createElement(h.II, {
                    type: "text",
                    className: "tw-w-full",
                    id: "email",
                    name: "email",
                    ...
                    onChange: le,
                    loading: I.checking
                }), I.value.includes("@") && I.error && d.createElement(_.bZ, {
                    role: "alert",
                    "aria-label": "Email Error"
                }, I.error), I.ok && d.createElement(h.II, {
                    type: "email",
                    id: "emailAgain",
                    inputMode: "email",
                    name: "emailAgain",
                ...
                }), I.ok && (R.ok ? d.createElement(h.II, {
                    type: "password",
                    id: "password",
                    name: "password",
                    className: "tw-mt-2 tw-w-full",
                ...
                }, "Emails do not match")), I.ok && R.ok && U && d.createElement(h.zx, {
                    onClick: function(e) {
                        e.preventDefault(), I.ok && R.ok && U && $({
                            userId: E.id,
                            email: I.value,
                            password: U
                        })
                    ...
                    type: "submit",
                    loading: !1
                }, "Update Email")), d.createElement(f.Qj, {
                    role: "link",
                    state: {
                        logout: !0
                    },
        ...
        83868: (e, t, r) => {
            Object.defineProperty(t, "__esModule", {
                ...
                for (var F = t.allow_utf8_local_part ? w : f, O = h.split("."), C = 0; C < O.length; C++)
                    if (!F.test(O[C])) return !1;
...
//# sourceMappingURL=c1211081eb2c5a32f68d3a952f5b1eae351e81dfc3c4bd1c73fa00c95b4164a9.js.map