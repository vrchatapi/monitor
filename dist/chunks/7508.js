    ...
    [7508], {
        7508: (e, a, t) => {
            ...
            const B = function() {
                ...
                var ee, ae = function() {
                        var e = (0, r.Z)(i().mark((function e(a) {
                            var t, r, n, l;
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 11:
                                        if (L((function(e) {
                                            ...
                                            })), e.t0 = (null == v ? void 0 : v.displayName) !== r, !e.t0) {
                                            e.next = 17;
                                            break
                                        }
                                        return e.next = 16, Z(r);
                                    case 16:
                                        e.t0 = e.sent;
                                    case 17:
                                        l = e.t0, L((function(e) {
                ...
                return ne && (ne.indexOf(":") > 0 ? (ne.substring(0, ne.indexOf(":")).trim(), ne = ne.substring(ne.indexOf(":") + 1).trim()) : 0 === ne.indexOf(":") && (ne = ne.substring(1).trim())), !b || k ? c.createElement(f.Z, null, c.createElement(w.$4, null, "Upgrade Account"), c.createElement("div", {
                ...
                }, "Upgrade Account"), c.createElement(w.qX, {
                    type: "error",
                    title: "Invalid token"
                }, "The link you have followed is not valid. Please check the link or try the process again later.", y && c.createElement(c.Fragment, null, c.createElement("br", null), null == y || null === (ee = y.data) || void 0 === ee || null === (ee = ee.error) || void 0 === ee ? void 0 : ee.message))), c.createElement("div", {
                    className: "tw-flex tw-flex-row tw-w-full tw-justify-center tw-mt-5"
                }, c.createElement(u.rU, {
                    to: "/home/login",
                    className: "tw-text-link-highlight"
                }, "Back to login")))) : T ? c.createElement(f.Z, null, c.createElement(w.$4, null, "Upgrade Account"), c.createElement("div", {
                    className: "tw-bg-darker-grey tw-w-full sm:tw-w-[500px] tw-py-9 tw-px-12 tw-rounded-lg tw-h-fit xl:tw-mt-[200px]"
                }, c.createElement("div", {
                    className: "tw-w-full tw-flex tw-flex-col tw-justify-center tw-items-center"
                }, c.createElement("div", {
                    ...
                    className: "tw-text-h2 tw-text-white tw-text-center tw-mb-6"
                }, "Upgrade Account"), c.createElement("p", null, "Your VRChat account has been upgraded, and your upgrade benefits have been applied."), c.createElement("p", null, "You can now sign in on any platform with your email address, gain Trust Ranks, upload Avatars & Worlds, and more. Have fun!")), c.createElement("div", {
                    className: "tw-flex tw-flex-row tw-w-full tw-justify-center tw-mt-5"
                }, c.createElement(h.Qj, {
                    to: "/home/login"
                }, "Login")))) : c.createElement(f.Z, null, c.createElement(w.$4, null, "Upgrade Account"), c.createElement("div", {
                    ...
                    className: "tw-text-h2 tw-text-white tw-text-center tw-mb-6"
                }, "Upgrade Account"), ne && c.createElement(w.qX, {
                    type: "error",
                    title: "Account upgrade error"
                }, ne), c.createElement("div", {
                    className: "tw-w-full tw-mb-3"
                }, c.createElement("label", {
                    htmlFor: "Email",
                    className: "tw-mb-2"
                }, "Email"), c.createElement(w.II, {
                    type: "text",
                    className: "tw-w-full",
                    id: "email",
                    name: "email",
                    ...
                    htmlFor: "displayName",
                    className: "tw-mb-2"
                }, "Display Name"), c.createElement(w.II, {
                    type: "text",
                    id: "displayName",
                    name: "displayName",
                    ...
                    className: "tw-mb-1",
                    isError: _.error
                }), !_.error && c.createElement("p", {
                    className: "tw-text-placeholder-text tw-text-xs tw-mb-0"
                }, "This is the name shown to other users in-app, you may only change your display name once per 90 days."), _.error && c.createElement("p", {
                    role: "alert",
                    "aria-label": "Display name error",
                    className: "tw-text-error-message-red tw-text-xs tw-mb-0 tw-mt-1"
                }, _.error)), c.createElement("div", {
                    className: "tw-w-full tw-mb-3"
                }, c.createElement("label", {
                    htmlFor: "Email",
                    className: "tw-mb-2"
                }, "Password"), c.createElement(w.II, {
                    type: "password",
                    name: "Password",
                    role: "textbox",
                    "aria-label": "Password",
                    ...
                    isError: X.error
                }), $.ok && X.error && c.createElement("p", {
                    role: "alert",
                    "aria-label": "Re-entered password error",
                    className: "tw-text-error-message-red tw-text-xs tw-mb-0 tw-mt-1"
                }, X.error)), c.createElement("div", {
        ...
        36678: (e, a, t) => {
            ...
            const s = function(e) {
                ...
                return n.createElement("div", {
                    ...
                    style: {
                        backgroundImage: null === i ? "none" : "url(".concat(i.imagePath, ")")
                    }
                }, n.createElement("div", {
                ...
                }, a), (null == i ? void 0 : i.worldName) && t && n.createElement("div", {
                ...
                }, n.createElement("strong", null, "World:"), " ", i.worldName), n.createElement("p", {
                    className: "tw-text-right mb-0"
                }, n.createElement("strong", null, "Author:"), " ", i.authorName)))
            }
        },
        65847: (e, a, t) => {
            t.d(a, {
            ...
            var o, i, c = {
                ...
                w = (new RegExp("[^".concat(m, "]"), "g"), Object.keys(c).map((function(e) {
                    return "\\u".concat(c[e].charCodeAt(0).toString(16).padStart(4, "0"))
                })).join("")),
                d = (new RegExp("[".concat(w, "]"), "g"), new RegExp("[^".concat(w, "]"), "g"), o = s, i = n()(o.characterAllowList.map((function(e) {
                    return e.ranges
                }))).map((function(e) {
                    return e.split("-").map((function(e) {
                        return "\\u".concat(e)
                    })).join("-")
                })), new RegExp("[^".concat(w).concat(i.join(""), "]"), "g")),
                p = function(e) {
                    var a = e;
...
//# sourceMappingURL=77f5ffba60898b829810ba4e20bd971ba50f69dc9c1a62e2d861ae27a6355b64.js.map