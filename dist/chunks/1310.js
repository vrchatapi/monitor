    ...
    [1310], {
        25272: (e, t, n) => {
            ...
            const b = function(e) {
                ...
                var S = function() {
                        "true" === new URL(window.location.href).searchParams.get("badUrl") && (P(!0), U(v))
                    },
                    I = function() {
                        var e = new URL(window.location.href).searchParams.get("redirect");
                        e && (y.some((function(t) {
                ...
                return a.createElement(c.Z, null, a.createElement(i.Z, {
                    ...
                    sm: "8",
                    md: "7"
                }, a.createElement(u.Z, null, a.createElement(i.Z, null, a.createElement("p", null, a.createElement("b", null, h), " wants read-only access to:"), a.createElement("ul", null, g.map((function(e) {
        ...
        23138: (e, t, n) => {
            ...
            function g(e) {
                var t = e.className,
                    ...
                    N = e.innerRef,
                    P = b(e, u),
                    x = (0, c.mx)(s()(t, "alert", "alert-".concat(g), {
                        "alert-dismissible": E
                    }), o),
