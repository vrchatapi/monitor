        ...
        38906: (e, t, r) => {
                ...
                K = function(e) {
                    var t = e.friendUserId,
                        ...
                        D = (0, g.useMemo)((function() {
                            ...
                            var e = (0, _.Z)(F).sort((function(e, t) {
            ...
            var X = r(40098),
                ...
                ee = function(e) {
                    ...
                    return g.createElement("div", {
                        ...
                        className: "tw-rounded tw-bg-option-bg tw-flex-col tw-absolute tw-w-full sm:tw-w-[12em] tw-top-[3.5em] tw-left-0 ".concat(c ? "tw-flex" : "tw-hidden"),
                        isOpen: c
            ...
            var oe = r(23208),
                ...
                pe = function(e) {
                                    ...
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 4:
                                            (r = new Image).addEventListener("load", (function() {
                                                ...
                                                var e;
                                                return W((null === (e = n.result) || void 0 === e ? void 0 : e.toString()) || "")
                    ...
                    }, "Confirm  ", Ge && g.createElement(I.$1, {
                        icon: o.LM,
                        spin: !0
                    }))))))
                };
            ...
            var ke = function(e) {
                var t, r, n, l = e.userId,
                    ...
                    _e = Oe.isSuccess,
                    We = (0, E.y)().data,
                    Ge = null !== (t = null == We || null === (r = We.constants) || void 0 === r || null === (r = r.LANGUAGE) || void 0 === r ? void 0 : r.SPOKEN_LANGUAGE_OPTIONS) && void 0 !== t ? t : y.O;
                if (!_e) return null;
                var He = je.currentAvatarImageUrl,
                    Ve = je.profilePicOverride,
                    Be = je.displayName,
                    Ke = je.userIcon,
                    Qe = je.tags,
                    Xe = je.bio,
                ...
                (0, g.useEffect)((function() {
                    ...
                    var e = Object.entries(Ge).map((function(e) {
                        var t = (0, a.Z)(e, 2),
                            r = t[0];
                        return {
                            label: t[1],
                ...
                return g.createElement("div", {
                ...
                }, !De && g.createElement("img", {
                    src: Ke || He || Ve,
                    alt: "".concat(Be, "'s user icon"),
                    className: "tw-w-40 tw-h-40 tw-rounded-full tw-shadow-lg tw-ml-5"
                }), De && g.createElement(I.UU, {
                ...
                }), !Q && te.length < y.Vh && g.createElement("button", {
                    type: "button",
                    ...
                    className: "\n                          tw-bg-darker-grey\n                          placeholder:tw-text-placeholder-text\n                          tw-rounded\n                          tw-h-14\n                          tw-p-4\n                          tw-w-full\n                          ".concat(Ee ? "tw-border-red tw-border-solid" : "tw-border-none", "\n                        "),
                    type: "text",
                    value: pe,
                    onChange: function(e) {
                    ...
                    onClick: function() {
                        return e = te.map((function(e) {
                            return "language_".concat(e.code)
                        })), t = Qe.filter((function(e) {
                            return e.startsWith("language")
                        })).filter((function(t) {
                            return !e.includes(t)
            ...
            const He = function() {
                ...
                if (ie) return null;
                if (se) {
                    var Ne, ke, Fe, Se = oe.displayName,
                        Ce = oe.bio,
                        Le = oe.bioLinks,
                        Te = oe.tags,
                        Pe = oe.profilePicOverride,
                        Ae = oe.currentAvatarImageUrl,
                        Re = oe.badges,
                        Ue = (0, S.H1)(Te, null !== (Ne = null == te || null === (ke = te.constants) || void 0 === ke || null === (ke = ke.LANGUAGE) || void 0 === ke ? void 0 : ke.SPOKEN_LANGUAGE_OPTIONS) && void 0 !== Ne ? Ne : y.O),
                        qe = Ue.some((function(e) {
                            return e.length > 8
                        }));
                    return g.createElement(F.rg, null, g.createElement(I.$4, null, null !== (Fe = se && (null == oe ? void 0 : oe.displayName)) && void 0 !== Fe ? Fe : "User"), C && g.createElement(Ie, {
                        userId: t,
                        isOpen: T,
                        cancelCallback: function() {
                            return P(!1)
                        ...
                        style: {
                            backgroundImage: "url(".concat(Pe || Ae, ")")
                        }
                    }, g.createElement("div", {
                        ...
                        "aria-label": "".concat(W ? "Unmute" : "Mute", " User")
                    }, g.createElement(I.$1, {
                        icon: s.Ek
                    }), " ", W ? "Unmute" : "Mute"), null !== B && g.createElement("span", {
                        className: "\n                                hover:tw-text-white hover:tw-bg-button-border\n                                  tw-w-full tw-flex tw-flex-row tw-justify-center tw-py-2.5\n                                  tw-text-center tw-cursor-pointer tw-items-center\n                                  ".concat(he ? "tw-hidden" : "tw-block", "\n                                "),
                        role: "button",
                        tabIndex: 0,
                        onClick: function() {
                        ...
                        "aria-label": "".concat(B ? "Unblock" : "Block", " User")
                    }, g.createElement(I.$1, {
                        icon: i.wO
                    }), " ", B ? "Unblock" : "Block"), g.createElement(Ze, {
                        userId: t,
...
//# sourceMappingURL=5b9a21c18e1d013adf8a55427d0c2e2733dfb80fabd9b8a19b48e2365ddc29fa.js.map