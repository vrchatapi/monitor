        ...
        78526(e, t, r) {
            ...
            var O = function(e) {
                var t = e.type,
                    ...
                    O = (0, N.T)(),
                    P = O.currentUser,
                    C = (O.isVrcPlusUser, O.isChurnedVrcPlusUser, O.isNeverHadVrcPlusUser, y.useState(!1)),
                    F = (0, l.A)(C, 2),
                    M = F[0],
                    T = F[1],
                    X = y.useState(null),
                    ...
                    te = y.useMemo(function() {
                        return H || (ee && Q ? Q.find(function(e) {
                            return e.favoriteId === n
                        }) : null)
                    }, [H, ee, Q, n]),
                    re = W || $ && Z,
                    ...
                    xe = y.useCallback(function(e) {
                        var t;
                        null !== (t = U.current) && void 0 !== t && t.contains(e.target) || T(!1)
                    }, [U.current]);
                ...
                var he = function() {
                            ...
                            return p().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 6:
                                        ...
                                        break;
                                    case 9:
                                        e.prev = 9, e.t0 = e.catch(3), g((0, f.X)({
                            ...
                            return p().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 4:
                                        ...
                                        break;
                                    case 6:
                                        e.prev = 6, e.t0 = e.catch(1), g((0, f.X)({
                    ...
                    ye = function(e) {
                        ...
                        return null != t && t.isVrcPlus ? A.w6[r] : r
                    },
                    Ee = function() {
                        var e = (0, o.A)(p().mark(function e(t) {
                            var r, a;
                            return p().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 6:
                                        e.prev = 6, e.t0 = e.catch(0), console.error("Failed to move favorite", e.t0), g((0, f.X)({
                    ...
                    Ne = function() {
                        var e = (0, o.A)(p().mark(function e(t) {
                            return p().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (T(!1), !((null == t ? void 0 : t.numFavorites) >= (null == t ? void 0 : t.maxFavoritesPerGroup))) {
                                            e.next = 5;
                                            break
                                        }
                                        return g((0, f.X)({
                                    ...
                                    case 8:
                                        return Y(t.name), e.abrupt("return");
                                    case 10:
                                        if (t.name === te.tags[0]) {
                                            e.next = 15;
                                            break
                ...
                if (y.useEffect(function() {
                        te && Y(te.tags[0])
                    }, [te]), be) return y.createElement(S.fy, {
                    width: "100%",
                    height: "49px",
                    className: "mt-2"
                });
                ...
                M && (je = te ? "Move Favorite" : "Select Collection"), le && (je = "Adding..."), ue && (je = "Deleting..."), pe && (je = "Moving...");
                var Se = le || ue || pe;
                return "private" === i && a !== (null == P ? void 0 : P.id) ? null : y.createElement(D, {
                    ref: U,
                    className: (0, v.cx)("tw:border-solid tw:border-2", {
                        "tw:hover:border-[#086c84]": !h,
                        "tw:border-2 tw:rounded-b-md tw:rounded-t-none tw:md:rounded-b-none tw:md:rounded-t-md": M,
                        "tw:border-[#086c84]": !h && M,
                        "tw:rounded-md": !M,
                        "tw:border-[#064b5c]": !h && !M
                    }, b),
                    isSelecting: M,
                    neutral: h
                    ...
                    type: "button",
                    onClick: he
                }, y.createElement(S.M2, {
                    icon: Ae,
                    className: "tw:mx-2"
                }), y.createElement("div", null, je)), y.createElement("button", {
                    className: "tw:flex tw:align-items-center tw:h-fit tw:bg-transparent tw:border-none tw:px-0",
                    type: "button",
                    onClick: function() {
                        T(!M)
                    }
                }, y.createElement(z, null), y.createElement(I, {
                    icon: c.Jt,
                    rotation: M ? 0 : 180,
                    ...
                    selectedGroup: R,
                    onGroupClick: Ne,
                    className: (0, v.cx)("tw:border-solid tw:select-none", "tw:bottom-[calc(100%+2px)] tw:rounded-t-md tw:border-t-2 tw:rounded-b-none tw:border-b-0", "tw:md:bottom-auto tw:md:top-[calc(100%+2px)] tw:md:rounded-t-none tw:md:rounded-b-md tw:md:border-b-2 tw:md:border-t-0", {
                        "tw:border-[#086c84]": !h
                    }),
                    neutral: h,
                    isOpen: M,
                    type: r
                }), Se && y.createElement(L, null, y.createElement(G, null)))
            };
            O.propTypes = {
            ...
            var C = {
                ...
                G = (0, i.A)("div", {
                    target: "e1o4xuq40"
                })("position:absolute;z-index:10;bottom:0;height:2px;background-color:var(--bs-success);animation-name:", M, ";animation-iteration-count:infinite;animation-duration:1.5s;animation-timing-function:ease-in-out;")
        },
        85005(e, t, r) {
            r.d(t, {
                A: () => l
        ...
        72839(e, t, r) {
            ...
            const k = function(e) {
                ...
                var F = function() {
                    ...
                    D = function() {
                        var e = (0, l.A)(w().mark(function e(a) {
                            return w().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                    ...
                    z = C ? k : A,
                    I = C ? s.Ex : c.jP;
                return m.createElement(b.Ay, (0, a.A)({
                    neutral: !0,
                    style: g({
                        lineHeight: "1"
                    }, d)
            ...
            var n = r(92619),
                ...
                v = function(e) {
                    ...
                    return p.createElement("div", {
                        ...
                        className: "tw:text-xs tw:mb-0"
                    }, "Purchasing will have no effect.")))) : null, !E && p.createElement(p.Fragment, null, p.createElement(l.$T, {
                        type: "warn",
                        title: p.createElement("small", null, "This avatar is unavailable due to an issue."),
                        className: "tw:mt-0"
                    }, p.createElement("small", null, "Please check your email or notifications for more information.")), p.createElement(l.fI, {
...
//# sourceMappingURL=4a8b1832adf06bfd5f186db145b65af609accecf41c41ee1312f09b4ae28e1d9.js.map