    ...
    [9809], {
        ...
        32085(e, t) {
            ...
            var r = "shop",
                n = ["store-alt"],
                a = "f54f",
                l = "M36.8 192l566.3 0c20.3 0 36.8-16.5 36.8-36.8c0-7.3-2.2-14.4-6.2-20.4L558.2 21.4C549.3 8 534.4 0 518.3 0L121.7 0c-16 0-31 8-39.9 21.4L6.2 134.7c-4 6.1-6.2 13.2-6.2 20.4C0 175.5 16.5 192 36.8 192zM64 224l0 160 0 80c0 26.5 21.5 48 48 48l224 0c26.5 0 48-21.5 48-48l0-80 0-160-64 0 0 160-192 0 0-160-64 0zm448 0l0 256c0 17.7 14.3 32 32 32s32-14.3 32-32l0-256-64 0z";
            t.mw = {
                prefix: "fas",
                iconName: r,
                icon: [640, 512, n, a, l]
        ...
        76500(e, t, r) {
            ...
            var n = r(58168),
                ...
                c = [{
                    ...
                    thumbnail: "https://assets.vrchat.com/www/profile_decorations/profile_backgrounds/BG_FutureCityStillness_Thumb.png",
                    isVRCPlus: !0
                }, {
                    id: "music",
                    label: "Music",
            ...
            var z = (0, U.AH)({
                    name: "1rn6p2w",
                    styles: "color:var(--profile-subtext-color, #9C9C9C)"
                }),
                q = function(e) {
                    var t = e.children,
                        r = e.title,
                    ...
                    }, n && f !== i.x9.COLOR && o.createElement("img", {
                        src: n,
                        height: w,
                        alt: r ? "".concat(r, " Banner") : "Panel banner image",
                        className: (0, U.cx)("tw-w-full tw-object-cover tw-aspect-[17/6]")
                    })), o.createElement("div", {
                        className: "".concat(d ? "tw-p-0" : "tw-p-4 md:tw-p-8")
                    }, r && o.createElement("h2", {
                        className: (0, U.cx)("tw-text-sm tw-font-bold tw-uppercase", z)
                    }, r), t)))
                };
            q.propTypes = {
                title: V().string,
            ...
            const W = q;
            var X = {
                    "facebook.com": L.vrcFacebook,
                    "twitch.tv": L.vrcTwitch,
                    "twitter.com": L.vrcTwitter,
                    "instagram.com": L.vrcInstagram,
                    "youtube.com": L.vrcYoutube,
                    "patreon.com": L.vrcPatreon,
                    "booth.pm": L.vrcBooth,
                    "discord.gg": L.vrcDiscord,
                    "discord.com": L.vrcDiscord,
                    "artstation.com": L.vrcArtstation,
                    "bandcamp.com": L.vrcBandcamp,
                    "furaffinity.net": L.vrcFuraffinity,
                    "github.com": L.vrcGithub,
                    "gitlab.com": L.vrcGitlab,
                    "gumroad.com": L.vrcGumroad,
                    "ko-fi.com": L.vrcKofi,
                    "linktr.ee": L.vrcLinktree,
                    "pixiv.net": L.vrcPixiv,
                    "sketchfab.com": L.vrcSketchfab,
                    "tiktok.com": L.vrcTikTok,
                    "soundcloud.com": L.vrcSoundCloud,
                    "store.vket.com": L.vrcVket
                },
                Y = function(e) {
                    try {
                        for (var t = new URL(e).hostname, r = 0, n = Object.entries(X); r < n.length; r++) {
                            var a = (0, l.A)(n[r], 2),
                                o = a[0],
                                c = a[1];
                            if (t === o || t.endsWith(".".concat(o))) return c
                        }
                    } catch (t) {
                        console.error("Invalid URL: ".concat(e))
                    }
                    return L.vrcGenericLink
                },
                H = (0, U.AH)({
                    name: "yngc5n",
                    styles: "color:var(--profile-icon-color, #2BAAC1)"
                }),
                $ = function(e) {
                    var t = e.urlPath;
            ...
            var ie = [le(), ce()],
                se = (0, U.i7)({
                    name: "qkigv2",
                    styles: "0%{transform:translateY(0) rotate(0deg);opacity:0;}15%{opacity:0.9;}85%{opacity:0.7;}100%{transform:translateY(-80px) rotate(var(--balloon-drift, 10deg));opacity:0;}"
                }),
                we = (0, U.AH)({
                    name: "3qf06o",
                    styles: "overflow:visible;position:relative;border-radius:0.5rem;padding:4px 8px;border:2px solid #252A30;border-style:solid;cursor:pointer;user-select:none;&:hover{background:#2E333D;}"
                }),
                ue = function(e, t) {
                    var r = "".concat((Math.random() > .5 ? 1 : -1) * (5 + 12 * Math.random()), "deg"),
                        n = "".concat(2 + 1.5 * Math.random(), "s"),
                        a = "".concat(16 + 8 * Math.random(), "px");
                    return (0, U.AH)("--balloon-drift:", r, ";position:absolute;width:", a, ";height:auto;left:", e, "px;top:", t, "px;animation:", se, " ", n, " ease-in-out forwards;opacity:0;pointer-events:none;", "")
                };
            const de = function(e) {
                var t, r, n = e.id,
                    a = e.className,
                    ...
                    b = (0, o.useCallback)(function(e) {
                        var t = e.currentTarget.getBoundingClientRect(),
                            r = e.clientX - t.left + 100 * (Math.random() - .5),
                            n = e.clientY - t.top + 100 * (Math.random() - .5),
                            a = g.current++,
                            l = ie[Math.floor(Math.random() * ie.length)];
                        f(function(e) {
                            return [].concat((0, ne.A)(e), [{
                                id: a,
                                style: ue(r, n),
                                sprite: l
                            }])
                ...
                }), "🎂 It's ", c ? "your" : function(e, t) {
                    if (!e) return "their";
                    switch (e.toLowerCase().trim().split("/")[0]) {
                        case "he":
                            return "his";
                        case "she":
                            return "her";
                ...
                }(i, s), " ", (t = w, r = new Intl.PluralRules("en-US", {
                    type: "ordinal"
                }), "".concat(t).concat({
                    one: "st",
                    two: "nd",
            ...
            var me = r(21591),
                ...
                Ne = function(e) {
                    ...
                    var g = n ? "".concat(t.name, " (Locked)") : t.name;
            ...
            var Ce = r(13671),
                ...
                Ie = function(e) {
                    var t = e.selectedItem,
                        r = e.selectionKey,
                        n = e.userIcon,
                        a = e.currentAvatarImageUrl,
                        l = e.displayName,
                        c = n || a,
                        i = (0, Ae.A)(t, r),
                        s = i.animationSource,
                        w = i.isIntroFinished,
                        u = i.animationResetKey,
                        d = w ? "".concat(u, "-main") : u,
                        m = t || {},
                        p = m.name,
                        f = m.acquiredOn,
            ...
            Ie.propTypes = {
                selectedItem: V().object,
                selectionKey: V().number,
                userIcon: V().string,
                currentAvatarImageUrl: V().string,
            ...
            var Te = r(80045),
                Se = function(e) {
                    var t = e.item,
                        ...
                        f = d.mainAnimation,
                        g = d.baseImage,
                        b = (0, Q.B)() ? null == g ? void 0 : g.url : (null == f ? void 0 : f.url) || (null == g ? void 0 : g.url),
                        h = m && p,
                        v = h ? {
                            background: "linear-gradient(to right, ".concat(m, ", ").concat(p, ")")
                        } : {};
            ...
            Se.propTypes = {
                item: V().object.isRequired,
                isSelected: V().bool,
                isLocked: V().bool,
                onClick: V().func.isRequired
            };
            const Oe = Se;
            var Me = ["nameplateEffect"],
                Re = function(e) {
                    var t = e.userData,
                        r = e.selectedItem,
                        n = r || {},
                        ...
                        s = n.name,
                        w = n.acquiredOn,
                        u = (0, Q.B)() ? null == i ? void 0 : i.url : (null == c ? void 0 : c.url) || (null == i ? void 0 : i.url),
                        d = "none" === (null == r ? void 0 : r.id),
            ...
            const Fe = {
                iconFrame: {
                    title: "Change Icon Frame",
                    label: "Your Icon Frames",
                    itemType: "iconFrame",
                    itemTypeLabel: "Icon Frame",
                    icon: L.vrcUser
                },
                profileEffect: {
                    ...
                    itemTypeLabel: "Profile Effect",
                    icon: L.vrcProfileEffect
                },
                nameplateEffect: {
                    title: "Change Nameplate Theme",
                    label: "Your Nameplates",
                    itemType: "nameplateEffect",
                    itemTypeLabel: "Nameplate Theme",
                    icon: L.vrcNameplateEffect
                }
            };
            ...
            var Ge = function(e) {
                var t = e.isOpen,
                    ...
                    P = M[1],
                    F = Fe[a],
                    L = (0, m.wX)(null == F ? void 0 : F.itemType, {
                        skip: !r || !(null != F && F.itemType)
                    }),
                    G = L.data,
                    B = L.isLoading,
                    U = (0, m.IB)({
                    ...
                    X = function() {
                        h(null), y(0), A(!1), S(!1), P(!1), u()
                    },
                    Y = (0, o.useMemo)(function() {
                        return D && F ? D.filter(function(e) {
                            return e.itemType === F.itemType
                        }) : []
                    }, [D, F]),
                    H = (0, o.useMemo)(function() {
                        return new Set(Y.map(function(e) {
                            return e.templateId
                        }))
                    }, [Y]),
                    $ = (0, o.useMemo)(function() {
                        return G && Array.isArray(G) ? new Map(G.map(function(e) {
                            return [e.id, e]
                        })) : new Map
                    }, [G]),
                    K = (0, o.useCallback)(function(e) {
                        var t, r, n, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                            l = (null == e || null === (t = e.metadata) || void 0 === t ? void 0 : t.assets) || [],
                            o = l.find(function(e) {
                        ...
                        return {
                            ...
                            mainAnimation: c,
                            baseImage: i,
                            gradientStart: null === (r = e.metadata) || void 0 === r ? void 0 : r.gradientStart,
                            gradientEnd: null === (n = e.metadata) || void 0 === n ? void 0 : n.gradientEnd,
                            acquiredOn: null == a ? void 0 : a.acquiredOn
                        }
                    }, []);
                (0, o.useEffect)(function() {
                    if (!r) return h(null), y(0), void A(!1);
                    if (q && $.size > 0) {
                        var e = $.get(q);
                        if (e) {
                            var t = Y.find(function(e) {
                                return e.templateId === q
                            });
                            h(K(e, t)), y(function(e) {
                                return e + 1
                            })
                        }
                    } else q || h({
                ...
                var J = (0, o.useMemo)(function() {
                    ...
                    Q = (0, o.useMemo)(function() {
                        ...
                        return {
                            vrcPlusExclusiveItems: e.filter(function(e) {
                                var t;
                    ...
                    Z = Q.vrcPlusExclusiveItems,
                    ee = Q.shopItems,
                    re = C ? J : J.slice(0, 6),
                    ae = J.length > 6,
                    le = T ? Z : Z.slice(0, 6),
                    oe = Z.length > 6,
                    ce = R ? ee : ee.slice(0, 6),
                    ie = ee.length > 6,
                    se = "nameplateEffect" === a,
                    we = (0, j.Wb)(i),
                    ue = (0, o.useMemo)(function() {
                        return !!b && ee.some(function(e) {
                            return e.id === b.id
                        })
                    }, [b, ee]),
                    de = (0, o.useMemo)(function() {
                        return !!b && Z.some(function(e) {
                            return e.id === b.id
                        })
                    }, [b, Z]);
                if (!r) return null;
                var me, ve, xe = function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        r = t.isLocked,
                        n = void 0 !== r && r,
                        a = t.isVRCPlusExclusive,
                        l = void 0 !== a && a;
                    return se && "none" !== e.id ? o.createElement(Oe, {
                        key: e.id,
                        item: e,
                        isSelected: (null == b ? void 0 : b.id) === e.id,
                        isLocked: n,
                        onClick: W
                    }) : o.createElement(ke, {
                        key: e.id,
                ...
                return o.createElement("div", {
                ...
                }, null == F ? void 0 : F.title)), o.createElement("button", {
                    type: "button",
                    ...
                    switch (a) {
                        case "iconFrame":
                            return o.createElement(_e, {
                                selectedItem: b,
                                selectionKey: E,
                                userIcon: null == i ? void 0 : i.userIcon,
                                currentAvatarImageUrl: null == i ? void 0 : i.currentAvatarImageUrl,
                                displayName: null == i ? void 0 : i.displayName
                            });
                        case "profileEffect":
                ...
                }, null == F ? void 0 : F.label), z && o.createElement("div", {
                    ...
                    return xe(e, {
                        isLocked: !we,
                        isVRCPlusExclusive: !0
                    })
                }))), oe && o.createElement("button", {
                    type: "button",
                    onClick: function() {
                        return S(!T)
                    },
                    className: "tw-flex tw-items-center tw-gap-2 tw-mt-4 tw-text-highlight tw-bg-transparent tw-border-none tw-cursor-pointer tw-mx-auto"
                }, T ? o.createElement(s.M2, {
                    icon: fe.w2
                }) : o.createElement(s.M2, {
                    icon: pe.Jt
                }), o.createElement("span", null, T ? "Show less" : "Show ".concat(Z.length - 6, " more")))), (B || ee.length > 0) && o.createElement("div", null, o.createElement("h3", {
                    className: "tw-text-white tw-text-sm tw-mb-4 heading"
                ...
                }))), !B && ie && o.createElement("button", {
                    type: "button",
                    onClick: function() {
                        return P(!R)
                    },
                    className: "tw-flex tw-items-center tw-gap-2 tw-mt-4 tw-text-highlight tw-bg-transparent tw-border-none tw-cursor-pointer tw-mx-auto"
                }, R ? o.createElement(s.M2, {
                    icon: fe.w2
                }) : o.createElement(s.M2, {
                    icon: pe.Jt
                }), o.createElement("span", null, R ? "Show less" : "Show ".concat(ee.length - 6, " more")))))), o.createElement("div", {
                ...
                }, "Go to the VRChat Shop to buy and collect this ", (null == F ? void 0 : F.itemTypeLabel) || "item"), o.createElement("div", {
                ...
                }, "Access exclusive ", (null == F ? void 0 : F.itemTypeLabel) || "item", "s with ", o.createElement(s.bD, null)), o.createElement("div", {
                    className: "tw-flex tw-gap-2"
                }, o.createElement("button", {
                    type: "button",
                    className: "".concat(me, " md:tw-w-32"),
            ...
            Ge.propTypes = {
                isOpen: V().bool,
                decorationType: V().oneOf(["iconFrame", "profileEffect", "nameplateEffect"]),
                userId: V().string,
                userData: V().object,
                onCancel: V().func,
                onApply: V().func
            ...
            var Ue = r(23892),
                De = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "#9C9C9C";
                    return (0, U.AH)("color:var(--profile-subtext-color, ", e, ");", "")
                },
                Ve = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "#6AE3F9";
                    return (0, U.AH)("color:var(--profile-icon-color, ", e, ");", "")
                },
                ze = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "#292D37";
                    return (0, U.AH)("background-color:var(--profile-button-color, ", e, ");&:hover{background-color:rgb(from var(--profile-button-color, ", e, ") r g b / 80%);}", "")
                },
                qe = function(e) {
                    var t = e.userData,
                        r = e.userLanguages,
                        ...
                        v = e.isLoading,
                        x = void 0 !== v && v,
                        R = e.onViewAllFriendsClick,
                        D = void 0 === R ? function() {} : R,
                        V = e.onViewAllGroupsClick,
                        z = void 0 === V ? function() {} : V,
                        q = e.profileEffect,
                        X = void 0 === q ? null : q,
                        Y = e.profileEffectKey,
                        H = void 0 === Y ? 0 : Y,
                        $ = e.iconFrame,
                        ee = void 0 === $ ? null : $,
                        ne = e.isPreview,
                        ...
                        ge = we.pronouns,
                        be = we.ageVerified,
                        he = we.ageVerificationStatus,
                        ve = we.bioLinks,
                        xe = we.bio,
                        Ee = we.iconUrl,
                        ye = we.id,
                        Ne = we.state,
                        ke = we.hasSharedConnectionsOptOut,
                        Ie = we.statusDescription,
                        _e = we.bannerType,
                        Te = we.bannerUrl,
                        Se = we.bannerColor,
                        Oe = we.date_joined,
                        ...
                        ut = (0, Q.Om)(),
                        dt = ie || Me || ut,
                        mt = (0, o.useMemo)(function() {
                            if (!Oe) return 0;
                            var e = te()(Oe),
                                t = te()();
                            return e.month() === t.month() && e.date() === t.date() ? t.year() - e.year() : 0
                        }, [Oe]),
                        pt = mt > 0,
                        ft = (0, Q.Xx)("about-me-settings-tooltip"),
                        gt = ft.shouldShow,
                        bt = ft.markAsSeen,
                        ht = (0, o.useRef)(null),
                        vt = (0, Ae.A)(X, H),
                        xt = vt.animationSource,
                        Et = vt.introSrc,
                        yt = vt.mainSrc,
                        Nt = (vt.baseSrc, vt.fallbackSrc, vt.isPlayingIntro),
                        kt = vt.isIntroFinished,
                        Ct = (vt.isLoading, vt.isReady),
                        At = vt.reducedAnimations,
                        It = (0, Q.F)({
                            src: Et,
                            resetKey: Ct ? H : null
                        }),
                    ...
                    (0, o.useLayoutEffect)(function() {
                        ht.current && it(ht.current.scrollHeight > ht.current.clientHeight)
                    }, [xe]);
                    var Tt = function() {
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 6:
                                            ...
                                            break;
                                        case 10:
                                            e.prev = 10, e.t0 = e.catch(3), console.error("Player Notes Error:", e.t0), le((0, F.X)({
                                                title: "Player Notes",
                                                icon: O.rf,
                        ...
                        St = function() {
                            var e = (0, E.A)(P().mark(function e() {
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return t = (0, h.Dk)("".concat(window.location.origin, "/home/user/").concat(ye)), e.next = 3, t();
                                        case 3:
                                            le((0, F.X)({
                        ...
                        Ot = Ct && Et && yt && !At,
                        Mt = (null == X ? void 0 : X.id) && "none" !== X.id && xt && !Ot;
                    return o.createElement(W, {
                    ...
                    }, Ot && o.createElement(o.Fragment, null, o.createElement("img", {
                        ref: It,
                        src: Et,
                        alt: "Profile effect intro",
                        className: "tw-absolute tw-inset-0 tw-w-full tw-object-cover tw-pointer-events-none tw-z-30 ".concat(Nt ? "tw-block" : "tw-hidden")
                    }), o.createElement("img", {
                        ref: _t,
                        src: yt,
                        alt: "Profile effect",
                        className: "tw-absolute tw-inset-0 tw-w-full tw-object-cover tw-pointer-events-none tw-z-30 ".concat(Nt ? "tw-hidden" : "tw-block")
                    })), Mt && o.createElement("img", {
                        key: "effect-".concat(null == X ? void 0 : X.id, "-").concat(H),
                        src: xt,
                        alt: "Profile effect",
                        ...
                        className: "tw-flex tw-flex-row tw-gap-2 tw-absolute -tw-translate-y-1/2 tw-top-0 tw-left-2 md:tw-left-6 ".concat(ee ? "tw-z-40" : "tw-z-20")
                    }, o.createElement(Ce.A, {
                        profilePic: Ee,
                        displayName: ue,
                        isLoading: x,
                    ...
                    }, ge && o.createElement("span", null, ge), !be && ie && o.createElement(s.$n, {
                        ...
                        neutral: !0,
                        onClick: function() {
                            return oe("/home/ageverification")
                        }
                    }, o.createElement(G.A, {
                        imageSize: "16px"
                        ...
                        alt: "VRC Plus Icon",
                        className: "tw-w-6"
                    })), be && "18+" === he && o.createElement("span", null, o.createElement(G.A, {
                        imageSize: "16px",
                        color: "#2BAAC1"
                    }), " Verified 18+"), st && o.createElement("span", null, o.createElement(B.A, {
                        imageSize: "16px",
                        color: "var(--user-level-".concat(wt, ")")
                    }), " ", st)), je && o.createElement("span", {
                        className: "tw-py-1 tw-px-2 tw-bg-dark-teal tw-rounded-lg tw-flex tw-items-center tw-gap-1.5 tw-border-solid tw-border tw-border-dark-teal"
                    }, o.createElement(s.M2, {
                        icon: L.vrcVerified,
                        className: "tw-text-teal"
                    }), o.createElement("span", {
                        className: "tw-text-white tw-font-medium"
                    }, "Creator")), u && o.createElement(s.$n, {
                        containerClasses: "tw-m-0",
                        neutral: !0,
                        transparent: !0,
                        onClick: function() {
                            return oe("/home/group/".concat(qe))
                        },
                    ...
                    }, "" !== Ge && o.createElement("img", {
                        src: Ge,
                        alt: "".concat(Be, " group icon"),
                        className: "tw-w-4 tw-h-4 tw-rounded-full"
                    }), o.createElement("span", {
                        className: "tw-truncate tw-max-w-[16ch]"
                    }, Be)), pt && o.createElement(de, {
                        id: "vrchat-birthday-".concat(ye),
                        className: "tw-text-light-grey",
                        isSelf: ie,
                        pronouns: ge,
                        displayName: ue,
                        vrchatBirthdayYears: mt,
                        dateJoined: Oe
                    }))), ye && !ke && !ie && o.createElement(s.lU, {
                        userId: ye,
                        onFriendsClick: D,
                        onGroupsClick: z
                        ...
                        icon: A.LF,
                        className: (0, U.cx)("tw-mr-2", Ve("#FFFFFF"))
                    }), "Edit Profile")), o.createElement(s.$n, {
                        onClick: St,
                        className: "tw-w-11"
                    }, o.createElement(s.M2, {
                        icon: C.Ex,
                        className: (0, U.cx)(Ve("#FFFFFF"))
                    }))), !ie && o.createElement("div", {
                        ...
                        className: (0, U.cx)("tw-text-sm tw-font-bold tw-uppercase", De())
                    }, "About Me"), "" !== xe && o.createElement("div", {
                        className: "tw-relative"
                    }, o.createElement("p", {
                        className: (0, U.cx)("tw-mb-0 tw-whitespace-pre-line tw-break-words", {
                            "tw-line-clamp-3 tw-overflow-hidden": !nt
                        }),
                        ref: ht
                    }, xe), ct && !nt && o.createElement("span", {
                        className: "tw-flex tw-items-center"
                    }, o.createElement("span", {
                        className: "tw-h-[1.5em] tw-bg-gradient-to-r tw-from-transparent tw-to-[#171A21]"
                    }), o.createElement("button", {
                        type: "button",
                        className: (0, U.cx)("tw-font-bold tw-p-0 tw-px-1 tw-appearance-none tw-border-none tw-bg-transparent", De()),
                        onClick: function() {
                            return at(!0)
                        }
                    }, "Read More"))), ie && "" === xe && o.createElement("div", {
                        ...
                        onClick: c
                    }, "Add a bio")), !ie && "" === xe && o.createElement("div", {
                        className: "tw-relative"
                    }, o.createElement("p", {
                        className: (0, U.cx)("tw-mb-0 tw-whitespace-pre-line tw-break-words", {
                            "tw-line-clamp-3 tw-overflow-hidden": !nt
                        ...
                        ref: ht
                    }, "No bio added."))), ve && (null == ve ? void 0 : ve.length) > 0 && o.createElement("div", {
                        ...
                        className: (0, U.cx)("tw-text-sm tw-font-bold tw-uppercase tw-mb-0", De())
                    }, "Languages"), o.createElement("div", {
                        className: "tw-flex tw-flex-row tw-items-center tw-gap-2 tw-flex-wrap"
                    }, r.map(function(e) {
                        return o.createElement("span", {
                            key: "language-".concat(e),
                            className: (0, U.cx)("tw-px-4 tw-w-fit tw-py-2 tw-rounded-full tw-bg-[#292D37]")
                        }, e)
                    }))), o.createElement("div", {
                        ...
                        icon: N.Qb
                    }))), !Ye && o.createElement(s.$n, {
                        onClick: function(e) {
                            He(!Ye), Qe(null != fe ? fe : ""), e.currentTarget.blur()
                        },
                        transparent: !0,
                        neutral: !0,
                        className: (0, U.cx)("tw-font-bold tw-text-left tw-flex tw-gap-2 tw-rounded-xl tw-border-none hover:tw-bg-grey tw-p-3", ze("#BABABA"))
                    }, o.createElement(s.M2, {
                        icon: y.bL,
                        size: "xl",
                        className: (0, U.cx)(Ve("#FFFFFF"))
                    }), fe && o.createElement("p", {
                        className: "tw-m-0"
                    }, fe), !fe && o.createElement("p", {
                        className: (0, U.cx)("tw-text-sm tw-font-bold tw-uppercase tw-mb-0 tw-text-subtext-grey tw-leading-loose")
                    }, "Add Note"))))))
                };
            qe.propTypes = {
                userData: V().shape({
                    ...
                    ageVerified: V().bool,
                    userIcon: V().string,
                    currentAvatarThumbnailImageUrl: V().string,
                    profilePicOverride: V().string,
                    currentAvatarImageUrl: V().string,
                    bioLinks: V().arrayOf(V().string),
                    bio: V().string,
                    id: V().string,
                    hasSharedConnectionsOptOut: V().bool
                }),
                userLanguages: V().arrayOf(V().string),
                userDetailsInfo: V().object,
                onEdit: V().func,
                onMute: V().func,
                onBlock: V().func,
                onFavorite: V().func,
                ...
                isMuted: V().bool,
                isLoading: V().bool,
                representingGroup: V().object,
                profileEffect: V().shape({
                    id: V().string,
                    imageUrl: V().string,
                    introAnimation: V().object,
                    mainAnimation: V().object,
                    baseImage: V().object
                }),
                profileEffectKey: V().number,
                iconFrame: V().shape({
                    id: V().string,
                    imageUrl: V().string,
                    introAnimation: V().object,
            ...
            Xe.propTypes = {
                badge: V().shape({
                    badgeId: V().string.isRequired,
                    badgeImageUrl: V().string.isRequired,
                    badgeName: V().string.isRequired,
            ...
            var He = function(e) {
                var t = e.badges,
                    ...
                    n = (t || []).filter(function(e) {
                        ...
                        return (t.showcased ? 1 : 0) - (e.showcased ? 1 : 0)
                    }).slice(0, 4),
                    a = (t || []).filter(function(e) {
                        return !e.hidden
                    }),
                    l = a.length > 4;
                return 0 === a.length ? null : o.createElement(W, {
                    title: "Badges"
                }, o.createElement("div", {
                    className: "tw-flex tw-flex-col"
                }, o.createElement("div", {
            ...
            var Ke = r(7800),
                ...
                Qe = function(e) {
                    ...
                    return o.createElement(o.Fragment, null, a && o.createElement(s.DF, null), l && o.createElement(W, {
                        title: "My Avatar"
                    }, o.createElement("div", {
            ...
            var et = r(71769),
                ...
                nt = r(26577),
                at = r(25538);
            const lt = r.p + "a7c5ec041cb49ca4f56fcda4869fb8e40ad13545b68935c3402b8ada15e518fc.svg";
            var ot = r(44877);
            var ct = "OFFLINE",
                it = "PRIVATE",
                st = "WEB",
                ...
                bt = function(e) {
                    var t = e.userLocation,
                        ...
                        b = i.isMobile,
                        v = i.isTraveling,
                        x = i.timeSinceLastActivity,
                        E = i.receivesMobileNotifications,
                        y = i.isOnline,
                        N = i.isUserMod,
                        k = "hidden" === t,
                        C = "string" == typeof t && t.startsWith("wrld_"),
                        A = (0, ot.Bi)({
                            location: t
                        }, {
                            skip: !y && !C
                        ...
                        V = T.location,
                        z = T.ownerId,
                        q = null == z ? void 0 : z.startsWith("grp_"),
                        X = (0, d.Yj)({
                        ...
                        Y = X.data,
                        H = X.isFetching,
                        $ = (X.isError, X.error, (0, o.useMemo)(function() {
                            return !!Y && Y.some(function(e) {
                                return e.groupId === z
                            })
                        }, [Y, z])),
                        K = (0, o.useMemo)(function() {
                            return p || !w && !u && !N || k ? ct : m ? st : b ? wt : f ? it : v ? ut : _ || H ? dt : I && S && F ? mt : pt
                        }, [p, w, u, N, f, k, m, b, v, _, H, I, S, F]),
                        J = (0, o.useMemo)(function() {
                            return V && l.locations[V] ? l.locations[V].users.filter(function(e) {
                                return e.id !== n.id
                            }) : []
                        }, [V, l, n]),
                        Z = (0, o.useMemo)(function() {
                            return 0 === J.length ? [] : J.slice(0, 3)
                        }, [J]),
                        ee = (0, o.useMemo)(function() {
                            return t ? (0, h.e2)(t) : ""
                        }, [t]),
                        te = (0, o.useMemo)(function() {
                            return !(!N && !u) || ("Group Public" === ee || (!("Group+" !== ee || !($ || J.length > 0)) || (!("Group" !== ee || !$) || (!("Friends" !== ee || !w) || !("Friends+" !== ee || !(w || J.length > 0))))))
                        }, [ee, $, J, w, u, N]),
                        re = _ || K !== mt ? null : (null == S ? void 0 : S.imageUrl) || (null == S ? void 0 : S.thumbnailImageUrl) || null,
                        ne = K === it || K === pt,
                        ae = "vrchat://launch?ref=vrchat.com&id=".concat(V).concat(B || D ? "&shortName=".concat(null != B ? B : D) : "", "&attach=1");
                    return o.createElement(W, {
                        bannerSrc: re || void 0,
                        bannerHeight: "265px",
                        noPadding: ne
                        ...
                        switch (K) {
                            ...
                            case it:
                                return o.createElement("div", {
                                    ...
                                    className: (0, U.cx)(" tw-text-sm tw-font-bold tw-uppercase", ft)
                        ...
                        className: (0, U.cx)("tw-flex tw-gap-2 tw-items-center tw-absolute tw-z-50 tw-top-5 tw-left-5 tw-bg-dark-grey/80 tw-py-3 tw-px-4 tw-rounded-3xl", ft)
                    }, o.createElement(s.M2, {
                        icon: L.vrcLocationWorld,
                        className: (0, U.cx)(gt())
                        ...
                        className: "tw-text-lighter-grey",
                        to: "/home/world/".concat(null == S ? void 0 : S.id)
                    }, null == S ? void 0 : S.name)), o.createElement("span", {
                    ...
                    }, G && o.createElement(nt.A, {
                        region: G,
                        imageSize: "24px",
                        className: "tw-h-6"
                    }), o.createElement("span", null, O, " - ", ee)), c && o.createElement("div", {
                        className: "tw-flex tw-flex-row tw-items-center tw-gap-2"
                    }, o.createElement(s.M2, {
                        icon: tt.GE,
                        className: (0, U.cx)("tw-text-[4px]", gt())
                    }), o.createElement("span", null, o.createElement(s.M2, {
                        icon: L.vrcAgeVerification,
                        className: "tw-text-teal",
                        size: "xl"
                        ...
                        icon: rt.faUserGroup,
                        className: (0, U.cx)("tw-mr-1 ", gt("#2baac1"))
                    }), " ", R, " / ", M), J.length > 0 && o.createElement("div", {
                        className: "tw-flex tw-flex-row tw-items-center tw-gap-2"
                    }, o.createElement(s.M2, {
                        icon: tt.GE,
                                    ...
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 5:
                                            return c((0, F.X)({
                                                ...
                                                message: "Favorite Saved to ".concat(p),
                                                icon: M.SG,
                                                color: "success",
                                                timeout: 5e3
                                            })), e.abrupt("return", a());
                                        case 9:
                                            return e.prev = 9, e.t0 = e.catch(2), console.error("Error creating favorite", e.t0), e.abrupt("return", c((0, F.X)({
            ...
            Et.propTypes = {
                friendUserId: V().string.isRequired,
                isOpen: V().bool.isRequired,
                cancelCallback: V().func
            };
            const yt = Et;
            var Nt = r(28045),
                kt = r(38066),
                ...
                Tt = function(e) {
                    ...
                    return o.createElement("div", {
                        ...
                        onClick: function() {
                            null != p && p.current && p.current.scrollIntoView({
                                behavior: "smooth",
                                block: "start"
                            }), m(!d)
                        },
                        ...
                        className: "tw-rounded tw-bg-option-bg tw-flex-col tw-absolute tw-w-full sm:tw-w-[12em] tw-top-[3.5em] tw-left-0 tw-z-10 ".concat(d ? "tw-flex" : "tw-hidden"),
                        isOpen: d
                    }, Object.keys(i.T2).filter(function(e) {
                        var r;
                        return "18+" !== e || null !== (r = null == t ? void 0 : t.isAdult) && void 0 !== r && r
                    }).map(function(e) {
                        return o.createElement("div", {
            ...
            Tt.propTypes = {
                statusType: V().oneOf(Object.keys(i.T2)),
                onChange: V().func,
                className: V().string
            };
            var St = (0, _t.A)("div", {
            ...
            Mt.propTypes = {
                statusType: V().oneOf(Object.keys(i.x4)),
                onChange: V().func,
                className: V().string
            };
            var Rt = (0, _t.A)("div", {
            ...
            var Ft = r(33326),
                ...
                zt = 2048,
                qt = function(e) {
                    var t, r, n, a = e.userId,
                        c = e.isOpen,
                        w = void 0 !== c && c,
                        u = e.cancelCallback,
                        d = void 0 === u ? function() {} : u,
                        f = e.mode,
                        b = void 0 === f ? "profileIcon" : f,
                        v = e.currentAvatarImageUrl,
                        x = void 0 === v ? "" : v,
                        y = e.bannerColor,
                        N = void 0 === y ? i.vf : y,
                        C = e.bannerType,
                        A = (void 0 === C && i.x9.COLOR, (0, re.wA)()),
                        I = (0, o.useState)(),
                        _ = (0, l.A)(I, 2),
                        T = _[0],
                        S = _[1],
                        ...
                        pe = me[0],
                        fe = me[1],
                        he = (0, o.useState)(null),
                        ve = (0, l.A)(he, 2),
                        xe = ve[0],
                        Ne = ve[1],
                        ke = (0, Q.T)(),
                        Ce = ke.isVrcPlusUser,
                        Ae = ke.isChurnedVrcPlusUser,
                        ...
                        Pe = Re.isLoading,
                        Fe = Re.error;
                    t = (0, E.A)(P().mark(function e() {
                        return P().wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    null != B && B.width && null != B && B.height && z.current && V.current && (0, Dt.d)(z.current, V.current, B, te, oe);
                                case 1:
                                case "end":
                                    return e.stop()
                            }
                        }, e)
                    })), r = 100, n = [B, te, oe], (0, o.useEffect)(function() {
                    ...
                    var je = function() {
                        ...
                        Le = (0, Ut.NL)({
                            ...
                            skip: "profileIcon" !== b || !w
                        }),
                        Ge = Le.data,
                        Be = void 0 === Ge ? [] : Ge,
                        Ue = Le.isFetching,
                        De = (Le.isSuccess, (0, Ut.A8)({
                            userId: a
                        }, {
                            skip: "profilePicture" !== b || !w
                        })),
                        Ve = De.data,
                        ze = void 0 === Ve ? [] : Ve,
                        qe = De.isFetching,
                        We = (De.isSuccess, (0, p.$V)()),
                        Xe = (0, l.A)(We, 2),
                        Ye = Xe[0],
                        He = Xe[1].isLoading,
                        $e = (0, p.QP)(),
                        ...
                        ct = {
                            ...
                            profilePicture: {
                                ...
                                feedbackTitle: "Change Profile Banner",
                                    ...
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 4:
                                            r = new Image, n = window.URL.createObjectURL(t.target.files[0]), r.addEventListener("load", function() {
                                                window.URL.revokeObjectURL(n), r.width < 64 || r.height < 64 ? ue({
                                                    pass: !1,
                                                ...
                                                once: !0
                                            }), r.src = n, S(void 0), (a = new FileReader).addEventListener("load", function() {
                                                var e;
                                                return J((null === (e = a.result) || void 0 === e ? void 0 : e.toString()) || "")
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            ...
                                            return e.abrupt("return", null == V ? void 0 : V.current);
                                        case 2:
                                            return t = V.current.width, r = V.current.height, n = Math.min(t, r), (a = document.createElement("canvas")).width = n, a.height = n, l = a.getContext("2d"), e.next = 11, l.drawImage(V.current, (V.current.width - n) / 2, (V.current.height - n) / 2, n, n);
                                        case 11:
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 5:
                                            ...
                                            break;
                                        case 8:
                                            e.prev = 8, e.t0 = e.catch(2), A((0, F.X)({
                                                title: "Delete Image",
                                                icon: ge.zp,
                                        ...
                                        case 11:
                                            return e.prev = 11, fe(!1), Ne(null), e.finish(11);
                                        case 15:
                                        case "end":
                                            return e.stop()
                                    }
                    ...
                    return o.createElement(o.Fragment, null, o.createElement("div", {
                        ...
                        icon: ge.zp,
                        color: "red"
                    }), " ", we.message)))), Ae && o.createElement(s.$T, {
                        type: "custom",
                        hideIcon: !0,
                        color: "#2E333D",
                        iconColor: "#F9FF00"
                        ...
                        icon: k.e6,
                        className: "tw-bg-[#F9FF0066] tw-border-[#F9FF00] tw-text-white tw-px-4 sm:tw-w-[200px]"
                    }, "Join VRC+")))), Te && (null == we ? void 0 : we.pass) && o.createElement("div", {
                        className: "tw-flex tw-flex-col"
                    }, o.createElement("div", {
                        className: "tw-pb-5 tw-flex tw-flex-row tw-justify-center"
                    }, o.createElement(Bt.Ay, {
                        crop: T,
                        ...
                        src: K,
                        style: {
                            transform: "scale(".concat(te, ") rotate(").concat(oe, "deg)")
                        },
                        onLoad: function(e) {
                        ...
                        value: te,
                        onChange: function(e) {
                            return ne(Number(e.target.value))
                        }
                    }), o.createElement(s.M2, {
                        icon: Nt.QL
                    })), o.createElement("div", {
                        ...
                        className: "tw-sr-only"
                    }, "Rotate Right")))), !!B && Te && (null == we ? void 0 : we.pass) && o.createElement("div", {
                        className: "tw-pb-5 tw-flex tw-flex-col"
                    }, o.createElement("h3", {
                        ...
                        return o.createElement(Vt.A, {
                            ...
                            onClick: (0, E.A)(P().mark(function t() {
                        ...
                        trigger: function(e) {
                            ...
                            return o.createElement("button", {
                                ...
                                "aria-label": "Default solid color banner"
                            })
                        }
                    }), "profilePicture" === b && x && o.createElement(Vt.A, {
                        key: "avatar-banner",
                        srcUrl: (0, h.Iu)({
                            fileUrl: x,
                            width: 512
            ...
            qt.propTypes = {
                ...
                isOpen: V().bool,
                cancelCallback: V().func,
                mode: V().oneOf(["profileIcon", "profileBanner"]),
                currentAvatarImageUrl: V().string,
                defaultBannerColor: V().string
            };
            const Wt = qt;
            var Xt = r(73906),
                Yt = r(47337),
                ...
                $t = function(e) {
                    ...
                    return o.createElement(o.Fragment, null, o.createElement("div", {
                        ...
                        onBlur: function() {
                            return m === r ? (N(""), void v(!1)) : (0, h.Gz)(m) ? t.includes(m) ? (N("This social link is already added"), void v(!0)) : (N(""), v(!1), void a({
                                fromValue: r,
                                toValue: m
                            })) : (N("Invalid social link"), void v(!0))
                        },
            ...
            var er = "#5D3F86",
                ...
                rr = function(e) {
                    var t = e.hasVrcPlus,
                        r = void 0 !== t && t,
                        n = e.backgroundType,
                        w = e.backgroundGradientTop,
                        u = e.backgroundGradientBottom,
                        d = e.backgroundTextureId,
                        m = (e.backgroundTemplateId, e.userId, e.onSave),
                        ...
                        x = n === i.N6.GRADIENT,
                        E = n === i.N6.TEXTURE,
                        y = (i.N6.INVENTORY, null != w && w.startsWith("#") ? w : "#".concat(w)),
                        N = null != u && u.startsWith("#") ? u : "#".concat(u),
                        C = !w || !u,
                        A = b ? c : c.slice(0, 5),
                        I = c.length - 5;
                    return o.createElement("div", {
                        ...
                        className: (0, U.cx)("tw-absolute tw-group tw-w-full tw-h-full tw-top-0 tw-left-0 tw-z-10 tw-border-solid tw-opacity-0 tw-overflow-hidden tw-border-[6px] hover:tw-opacity-100 tw-border-dark-blue-purple tw-rounded-2xl hover:tw-border-teal", {
                        ...
                        defaultColors: {
                            backgroundGradientTop: C ? er : y,
                            backgroundGradientBottom: C ? tr : N
                        },
                        showCancel: !0,
                        showNameInput: !1,
                        onSave: function(e, t) {
                        ...
                        trigger: function(e) {
                            ...
                            return o.createElement("button", {
                                ...
                                style: {
                                    background: "linear-gradient(to top, ".concat(C ? "".concat(tr, ", ").concat(er) : "".concat(N, ", ").concat(y), ")")
                                }
                            }, o.createElement("div", {
                        ...
                        return o.createElement("button", {
                            ...
                            className: (0, U.cx)("tw-aspect-video tw-rounded-2xl tw-overflow-hidden ", {
                    ...
                    }, b ? "Show Less" : "Show All (+".concat(I, ")"))))
                };
            rr.propTypes = {
                backgroundType: V().string,
                backgroundGradientTop: V().string,
                backgroundGradientBottom: V().string,
                backgroundTextureId: V().string,
                backgroundTemplateId: V().string,
                userId: V().string,
                onSave: V().func
            };
            const nr = rr;
            ...
            var lr = function(e) {
                var t = e.value,
                    ...
                    x = n.length >= 20,
                    y = (0, o.useMemo)(function() {
                        return [].concat((0, ne.A)(i.wZ), (0, ne.A)(n))
                    }, [n]);
                (0, o.useEffect)(function() {
                    f(t)
                }, [t]);
                var N = h ? y : y.slice(0, 6),
                    C = function() {
                        var e = (0, E.A)(P().mark(function e(t) {
                            var r, n, a;
                            return P().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (r = t.themeId, n = t.themeName, a = t.colors, e.prev = 1, !w) {
                                            e.next = 5;
                                            break
                                        }
                                        return e.next = 5, w({
                                    ...
                                    case 5:
                                        ...
                                        break;
                                    case 8:
                                        e.prev = 8, e.t0 = e.catch(1), console.error("Error saving theme:", e.t0);
                                    case 11:
                                    case "end":
                                        return e.stop()
                                }
                ...
                return o.createElement("div", {
                    ...
                    className: (0, U.cx)("tw-gap-3 tw-grid", {
                    ...
                    trigger: function(e) {
                        ...
                        return o.createElement(s.$n, {
                            ...
                            className: (0, U.cx)("tw-bg-dark-blue-purple tw-border-none", {
                    ...
                    return o.createElement("div", {
                        ...
                        className: (0, U.cx)("tw-group tw-border-solid tw-w-28 tw-h-28 tw-relative tw-overflow-hidden tw-border-[6px] tw-bg-dark-blue-purple tw-border-dark-blue-purple tw-rounded-2xl hover:tw-border-teal hover:tw-bg-teal", {
            ...
            lr.propTypes = {
                value: V().string.isRequired,
                themes: V().arrayOf(V().shape({
                    id: V().string.isRequired,
                    name: V().string.isRequired,
                    iconColor: V().string.isRequired,
                    buttonColor: V().string.isRequired,
                    subtextColor: V().string.isRequired,
                    isPreset: V().bool
                })),
                onCreate: V().func,
                onSave: V().func,
            ...
            const or = lr;
            var cr = 512,
                ir = ["they/them", "he/him", "she/her", "it/its", "any", "ze/zir", "xe/xem"],
                sr = "other-638aa0b1f0f04640ba6425d1fd55d8",
                wr = function(e) {
                    var t, r, n, c, w = e.userId,
                        d = e.isOpen,
                        f = void 0 !== d && d,
                        g = e.cancelCallback,
                        b = void 0 === g ? function() {} : g,
                        v = (0, o.useState)("ask me"),
                        x = (0, l.A)(v, 2),
                        y = x[0],
                        N = x[1],
                        k = (0, o.useState)(""),
                        ...
                        gt = (0, m.xL)(),
                        bt = (0, l.A)(gt, 1)[0],
                        ht = (0, o.useState)("default"),
                        vt = (0, l.A)(ht, 2),
                        xt = vt[0],
                        Et = vt[1],
                        yt = (0, u.G)().data,
                        _t = null !== (t = null == yt || null === (r = yt.constants) || void 0 === r || null === (r = r.LANGUAGE) || void 0 === r ? void 0 : r.SPOKEN_LANGUAGE_OPTIONS) && void 0 !== t ? t : i.RY,
                        Tt = (0, o.useRef)(!1),
                        St = (0, o.useRef)(!0);
                    (0, o.useEffect)(function() {
                        f || (Tt.current = !1)
                    ...
                    var Mt = lt || {},
                        Rt = Mt.currentAvatarImageUrl,
                        Ft = Mt.profilePicOverride,
                        jt = Mt.displayName,
                        Lt = Mt.userIcon,
                        Gt = (Mt.tags, Mt.bio),
                        Bt = Mt.bioLinks,
                        Ut = Mt.pronouns,
                        Dt = Mt.status,
                        Vt = Mt.statusDescription,
                        zt = Mt.ageVerified,
                        qt = Mt.isAdult,
                        Yt = Mt.ageVerificationStatus,
                        Ht = (Mt.trustTags, Mt.themeId),
                        $t = Mt.bannerColor,
                        Zt = Mt.bannerType,
                        er = Mt.bannerUrl,
                        tr = Mt.bannerCustomUrl,
                        rr = Mt.languages,
                        ar = Mt.hasVrcPlus,
                        lr = Mt.themes,
                        wr = Mt.backgroundType,
                        ur = Mt.backgroundGradientTop,
                        dr = Mt.backgroundGradientBottom,
                        mr = Mt.backgroundTextureId,
                        pr = Mt.backgroundTemplateId,
                        fr = Se.length !== (null !== (n = null == Bt ? void 0 : Bt.length) && void 0 !== n ? n : 0) || Se.some(function(e, t) {
                            return e !== (null == Bt ? void 0 : Bt[t])
                        }),
                        gr = y !== Dt || A !== Vt || z !== Ut || fr || zt && M !== Yt;
                    (0, o.useEffect)(function() {
                        (St.current || f) && (St.current = !1, Tt.current || lt && (Tt.current = !0, I(Vt), U(Gt), H("" !== Ut && !ir.includes(Ut)), q(null != Ut ? Ut : ""), Oe(null != Bt ? Bt : []), N(Dt), R(Yt)))
                    }, [f, lt]), (0, o.useEffect)(function() {
                        Qe && We({
                            error: Ze
                        })
                    }, [Qe, Ze]), (0, o.useEffect)(function() {
                        if (rr) {
                            var e = rr.map(function(e) {
                                return {
                                    code: e,
                                    title: _t[e]
                                }
                    ...
                    }, [rr]), (0, o.useEffect)(function() {
                        var e = Object.entries(_t).map(function(e) {
                            var t = (0, l.A)(e, 2),
                                r = t[0];
                            return {
                                label: t[1],
                        ...
                        Ie(e)
                    }, [ye]), (0, o.useEffect)(function() {
                        Ht && Et(Ht)
                    }, [Ht]);
                    var br = (0, o.useMemo)(function() {
                        var e;
                        return !!Je || (null !== (e = null == B ? void 0 : B.length) && void 0 !== e ? e : 0) > cr
                    }, [Je, B]);
                    if (!lt) return null;
                    var hr, vr = function() {
                        return "" === Pe ? (Ue(!1), void qe("")) : (0, h.Gz)(Pe) ? Se.includes(Pe) ? (qe("This social link is already added"), void Ue(!0)) : (Ue(!1), qe(""), Fe(""), void Oe([].concat((0, ne.A)(Se), [Pe.trim()]))) : (qe("Invalid social link"), void Ue(!0))
                    };
                    if (ct) return o.createElement("div", {
                        tabIndex: "-1",
                        ...
                        className: " tw-w-full tw-text-xl tw-font-semibold tw-text-white after:tw-content-[''] after:tw-border-gray-700 after:tw-border-solid after:tw-border-0 after:tw-border-t after:tw-pb-0 after:tw-mt-5 "
                    }, "Failed To Load User Data"), o.createElement("code", null, null === (hr = it.data) || void 0 === hr || null === (hr = hr.error) || void 0 === hr ? void 0 : hr.message)));
                    var xr = function() {
                            var e = (0, E.A)(P().mark(function e(t) {
                                var r, n, a, l;
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 3:
                                            n = e.sent, r = n.id, Xe((0, F.X)({
                                                title: "Theme Created",
                                                message: 'Theme "'.concat(t.name, '" has been created successfully!'),
                                                icon: At.fy,
                                                color: "success",
                                                timeout: 3e3
                                            })), e.next = 12;
                                            break;
                                        case 8:
                                            return e.prev = 8, e.t0 = e.catch(0), Xe((0, F.X)({
                                                title: "Error Creating Theme",
                                                message: (null === (a = e.t0.data) || void 0 === a || null === (a = a.error) || void 0 === a ? void 0 : a.message) || "An error occurred while creating the theme.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            })), e.abrupt("return");
                                        case 12:
                                            return e.prev = 12, e.next = 15, ut({
                                                userId: w,
                                                updates: {
                                                    themeId: r
                                                }
                                        ...
                                        case 15:
                                            ...
                                            break;
                                        case 18:
                                            e.prev = 18, e.t1 = e.catch(12), Xe((0, F.X)({
                                                title: "Error Selecting Theme",
                                                message: (null === (l = e.t1.data) || void 0 === l || null === (l = l.error) || void 0 === l ? void 0 : l.message) || "An error occurred while selecting the theme.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            }));
                        ...
                        Er = function() {
                            var e = (0, E.A)(P().mark(function e(t) {
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            if (r = t.themeId, n = t.themeName, a = t.colors, Et(r), !(l = null == lr ? void 0 : lr.find(function(e) {
                                                    return e.id === r
                                                })) || !a) {
                                                e.next = 15;
                                                break
                                            }
                                            return e.prev = 4, e.next = 7, ft({
                                                userId: w,
                                                themeId: r,
                                                theme: {
                                                    name: n || l.name,
                                        ...
                                        case 7:
                                            Xe((0, F.X)({
                                                title: "Theme Updated",
                                                message: 'Theme "'.concat(n || l.name, '" has been updated successfully!'),
                                                icon: At.fy,
                                                color: "success",
                                                timeout: 3e3
                                            })), e.next = 15;
                                            break;
                                        case 10:
                                            return e.prev = 10, e.t0 = e.catch(4), console.error("Error updating theme", e.t0), Xe((0, F.X)({
                                                title: "Error Updating Theme",
                                                message: (null === (o = e.t0.data) || void 0 === o || null === (o = o.error) || void 0 === o ? void 0 : o.message) || "An error occurred while updating the theme.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            })), e.abrupt("return");
                                        case 15:
                                            return c = i.wZ.some(function(e) {
                                                return e.id === r
                                            }), s = {
                                                themeId: c ? "" : r,
                                                iconColor: a.iconColor,
                                        ...
                                        case 20:
                                            ...
                                            break;
                                        case 22:
                                            e.prev = 22, e.t1 = e.catch(17), Et(null != r ? r : "default"), Xe((0, F.X)({
                                                title: "Error Selecting Theme",
                                                message: (null === (u = e.t1.data) || void 0 === u || null === (u = u.error) || void 0 === u ? void 0 : u.message) || "An error occurred while selecting the theme.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            }));
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 3:
                                            ...
                                            return Et("default"), e.next = 7, ut({
                                                userId: w,
                                                updates: {
                                                    themeId: "default",
                                                    iconColor: i.wZ[0].iconColor,
                                                    buttonColor: i.wZ[0].buttonColor,
                                                    subtextColor: i.wZ[0].subtextColor
                                                }
                                            }).unwrap();
                                        case 7:
                                            Xe((0, F.X)({
                                            ...
                                            break;
                                        case 10:
                                            e.prev = 10, e.t0 = e.catch(0), Xe((0, F.X)({
                                                title: "Error Deleting Theme",
                                                message: (null === (r = e.t0.data) || void 0 === r || null === (r = r.error) || void 0 === r ? void 0 : r.message) || "An error occurred while deleting the theme.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            }));
                        ...
                        Nr = function() {
                            var e = (0, E.A)(P().mark(function e(t) {
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return r = t.backgroundType, n = t.backgroundGradientTop, a = t.backgroundGradientBottom, l = t.backgroundTextureId, o = {
                                                backgroundType: r
                                            }, r === i.N6.GRADIENT && (o.backgroundGradientTop = n.replace("#", ""), o.backgroundGradientBottom = a.replace("#", "")), r === i.N6.TEXTURE && (o.backgroundTextureId = l), e.prev = 4, e.next = 7, ut({
                                                userId: w,
                                                updates: o
                                            }).unwrap();
                                        case 7:
                                            ...
                                            break;
                                        case 9:
                                            e.prev = 9, e.t0 = e.catch(4), console.error("Error updating background", e.t0), Xe((0, F.X)({
                                                title: "Error Updating Background",
                                                message: (null === (c = e.t0.data) || void 0 === c || null === (c = c.error) || void 0 === c ? void 0 : c.message) || "An error occurred while updating the background.",
                                                icon: At.fy,
                                                color: "error",
                                                timeout: 3e3
                                            }));
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            ...
                                            return e.abrupt("return");
                                        case 2:
                                            return r = "none" === (null == t ? void 0 : t.id) ? "" : null == t ? void 0 : t.templateId, e.prev = 3, e.next = 6, ut({
                                                userId: w,
                                                updates: (0, a.A)({}, ue, r)
                                            }).unwrap();
                                        case 6:
                                            ...
                                            break;
                                        case 9:
                                            e.prev = 9, e.t0 = e.catch(3), Xe((0, F.X)({
                                                title: "Profile Decoration",
                                                icon: O.rf,
                                                message: "Failed to update decoration. ".concat((null === (n = e.t0.data) || void 0 === n || null === (n = n.error) || void 0 === n ? void 0 : n.message) || "Please try again."),
                                                color: "danger",
                                                timeout: 5e3
                                            }));
                                        case 12:
                        ...
                        Cr = function() {
                            var e = (0, E.A)(P().mark(function e() {
                                ...
                                return P().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return e.prev = 0, e.next = 3, ut({
                                                userId: w,
                                                updates: {
                                                    bio: B,
                                                    bioLinks: Se,
                                                    themeId: xt,
                                                    languages: ye.map(function(e) {
                                                        return e.code
                                                    })
                                                }
                                            }).unwrap();
                                        case 3:
                                            ...
                                            return (t = {}).status = y, t.statusDescription = A, t.pronouns = z, zt && (t.ageVerificationStatus = M), i.O3 && (t.bio = B, t.bioLinks = Se), e.next = 13, $e({
                                                userId: w,
                                                data: t
                                            }).unwrap();
                                        case 13:
                                            ...
                                            if (r = ye.map(function(e) {
                                                    return e.code
                                                }), n = rr || [], a = r.filter(function(e) {
                                                    return !n.includes(e)
                                            ...
                                            return o = l.map(function(e) {
                                                return "language_".concat(e)
                                            }), e.next = 22, nt({
                                                userId: w,
                                                tagList: o
                                            }).unwrap();
                                        ...
                                        case 26:
                                            ...
                                            break;
                                        case 29:
                                            return e.prev = 29, e.t0 = e.catch(0), console.error("Error updating user profile:", e.t0), Xe((0, F.X)({
                                                title: "Update Profile",
                                                icon: S.X4,
                                        ...
                                        case 34:
                                            z !== Ut && (0, Qt.u4)("Social_UpdatePronouns", {
                                                targetUserId: w,
                                                source: "web",
                                                text: z
                                            });
                        ...
                        Ar = Zt === i.x9.CUSTOM && tr,
                        Ir = Zt === i.x9.AVATAR && er,
                        _r = Zt === i.x9.COLOR;
                    return o.createElement("div", {
                        tabIndex: "-1",
                        className: "\n        tw-top-0 tw-left-0 tw-right-0 tw-z-[1040]\n        tw-overflow-x-hidden tw-overflow-y-auto\n        md:tw-inset-0\n        tw-max-h-full\n        tw-bg-dark-grey-transparent\n        ".concat(f ? "tw-fixed" : "tw-hidden", "\n      "),
                        ...
                        mode: te,
                        currentAvatarImageUrl: Rt,
                        bannerColor: $t || i.vf,
                        bannerType: Zt || i.x9.COLOR
                    }), o.createElement(Be, {
                        isOpen: ce,
                        decorationType: ue,
                        userId: w,
                        ...
                        hasVrcPlus: ar,
                        backgroundType: wr,
                        backgroundGradientTop: ur,
                        backgroundGradientBottom: dr,
                        backgroundTextureId: mr,
                        backgroundTemplateId: pr,
                        userId: w,
                        onSave: Nr
                    }), o.createElement("div", {
                        className: "tw-flex tw-flex-col"
                        ...
                        type: "text",
                        placeholder: "Introduce yourself in any way you like. ".concat(cr, " characters max."),
                        onChange: function(e) {
                    ...
                    }, B.length, "/", cr))), zt && qt && o.createElement("div", {
                        className: "tw-flex tw-flex-col"
                    }, o.createElement("div", {
                        className: "tw-flex tw-flex-col"
                    }, o.createElement("label", {
                        className: "tw-mb-3",
                        htmlFor: "input-age-verification"
                    }, "Age Verification"), o.createElement(Ot, {
                        ...
                        onChange: function(e) {
                            ...
                            if (t === sr) return H(!0), void q("");
                            H(!1), q(t)
                        }
                    }, o.createElement("option", {
                        value: ""
                    }, "Unlisted"), o.createElement("optgroup", {
                        label: "Suggestions"
                    }, ir.map(function(e) {
                        ...
                        return o.createElement(Xt.A, {
                            ...
                            onChange: function(e) {
                                ! function(e) {
                                    var t = e.from,
                                        r = e.to,
                                        n = ye.findIndex(function(e) {
                                            return t.code === e.code
                                        }),
                                        a = (0, ne.A)(ye);
                                    if (null === r) return a.splice(n, 1), void Ne(a);
                                    a[n] = r, Ne(a)
                                }(e)
                            },
                            options: Ae
                        })
                    }), fe && o.createElement(Jt.A, {
                    ...
                    }, "Social Links"), null == Se ? void 0 : Se.map(function(e, t) {
                        return o.createElement(Kt, {
                            ...
                            onDelete: function(e) {
                                Oe((0, ne.A)(Se.filter(function(t) {
                                    return t !== e
                                })))
                            }
                        })
                    }), (null == Se ? void 0 : Se.length) < 3 && o.createElement(o.Fragment, null, o.createElement("div", {
            ...
            mr.propTypes = {
                group: V().shape({
                    groupId: V().string.isRequired,
                    iconUrl: V().string,
                    name: V().string,
                    isRepresenting: V().bool
                }).isRequired
            };
            const pr = mr;
            var fr = function(e) {
                ...
                if (p) {
                    var f = i || [],
                        b = (0, ne.A)(f).sort(function(e, t) {
                            return (t.isRepresenting ? 1 : 0) - (e.isRepresenting ? 1 : 0)
                        }).slice(0, 5),
                        h = f.length > 5;
                    return 0 === f.length ? l ? o.createElement(W, {
                        title: "Groups"
                    }, o.createElement("div", {
                    ...
                    }, "Explore Groups"))) : o.createElement(W, {
                        title: "Groups"
                    }, o.createElement("div", {
                        className: "tw-flex tw-items-center tw-justify-center tw-min-h-[100px]"
                    }, o.createElement("p", {
                        className: "tw-text-light-grey"
                    }, "No groups to show"))) : o.createElement(W, {
                        title: "Groups"
                    }, o.createElement("div", {
                        className: "tw-flex tw-flex-col"
                    }, o.createElement("div", {
            ...
            var br = function(e) {
                ...
                (0, o.useEffect)(function() {
                    ...
                    return t && document.addEventListener("keydown", e),
                        function() {
                            document.removeEventListener("keydown", e)
                        }
                }, [t, r]);
                var p, f = (0, o.useCallback)(function() {
                    if (m.current && !c && i && w) {
                        var e = m.current,
                            t = e.scrollTop;
                        e.scrollHeight - t - e.clientHeight < 100 && w()
                    }
                }, [c, i, w]);
                return o.createElement(s.aF, {
                    isVisible: t,
                    onClose: r,
                    title: n,
                    width: "900px",
            ...
            vr.propTypes = {
                ...
                renderListItem: V().func.isRequired,
                isLoading: V().bool
            };
            const xr = vr;
            var Er = r(22978),
            ...
            var kr = (0, U.AH)({
                    name: "bnj4tq",
                    styles: "background-color:rgba(6, 75, 92, 0.8);border-color:rgba(8, 108, 131, 0.5);background-color:rgb(from var(--profile-button-color, #064B5C) r g b / 80%);border-color:rgb(from var(--profile-icon-color, #086C83) r g b / 50%);&:hover{background-color:#064B5C;background-color:rgb(from var(--profile-button-color, #064B5C) r g b / 100%);}"
                }),
                Cr = (0, U.AH)({
                    name: "y88gg",
                    styles: "color:var(--profile-icon-color, #6AE3F9)"
                }),
                Ar = function(e) {
                    var t = e.direction,
                        r = e.onClick,
                    ...
                    return o.createElement("button", {
                        type: "button",
                        onClick: r,
                        className: (0, U.cx)(kr, "group-hover:tw-opacity-100 tw--translate-y-1/2 tw-absolute tw-border-2 tw-border-solid tw-p-2 tw-rounded-md tw-top-1/2 tw-transition-opacity tw-z-10", "left" === t ? "tw--left-2 md:tw--left-6" : "tw--right-2 md:tw--right-6", a),
                        "aria-label": "Scroll ".concat(t)
                    }, o.createElement(s.M2, {
                        icon: "left" === t ? Nr.Wz : yr.Xk,
                        className: (0, U.cx)(Cr, "tw-w-6 tw-h-8")
                    }))
                };
            Ar.propTypes = {
                direction: V().oneOf(["left", "right"]).isRequired,
                onClick: V().func.isRequired,
                className: V().string
            };
            const Ir = Ar;
            var _r = r(60188),
                Tr = function(e) {
                    var t = e.folderName,
                        ...
                        w = e.onClick,
                        u = n.slice(0, 4),
                        d = [].concat((0, ne.A)(u), (0, ne.A)(Array(4 - u.length).fill(null)));
                    return o.createElement("button", {
                        type: "button",
                        onClick: w,
            ...
            Tr.propTypes = {
                folderName: V().string.isRequired,
                worlds: V().arrayOf(V().shape({
                    id: V().string,
                    name: V().string,
                    imageUrl: V().string
                })),
                numFavorites: V().number,
            ...
            var Rr = function(e) {
                var t = e.group,
                    ...
                    l = (0, o.useMemo)(function() {
                        return null != a && a.favorites ? a.favorites.map(function(e) {
                            return e.world
                        }).filter(Boolean) : []
                    }, [a]),
                    c = (0, o.useMemo)(function() {
                        return l.slice(0, 4).map(function(e) {
                            return {
                                id: e.id,
                                name: e.name,
                                imageUrl: e.imageUrl
            ...
            var Fr = function(e) {
                var t = e.userName,
                    ...
                    a = (0, o.useMemo)(function() {
                        return r.slice(0, 4).map(function(e) {
                            return {
                                id: e.id,
                                name: e.name,
                                imageUrl: e.imageUrl
                ...
                return o.createElement(Sr, {
                    folderName: "".concat(t, "'s uploaded worlds"),
                    worlds: a,
                    numFavorites: r.length,
                    onClick: function() {
                        null == n || n({
                            type: "uploaded",
                            displayName: "".concat(t, "'s Uploaded Worlds"),
                            worlds: r
                        })
                    }
                })
            ...
            var Br = function(e) {
                ...
                (0, o.useEffect)(function() {
                    var e = i.current;
                    if (e) return T(), e.addEventListener("scroll", T), window.addEventListener("resize", T),
                        function() {
                ...
                var S = (0, o.useMemo)(function() {
                        return [].concat((0, ne.A)(((null == y ? void 0 : y.favoriteGroups) || []).map(function(e) {
                            return Gr(Gr({}, e), {}, {
                                type: "world"
                            })
                        })), (0, ne.A)(((null == A ? void 0 : A.favoriteGroups) || []).map(function(e) {
                            return Gr(Gr({}, e), {}, {
                                type: "vrcPlusWorld"
                            })
                        })))
                    ...
                    M = x.length > 0,
                    R = S.length > 0;
                return M || R ? o.createElement(W, {
                    title: "Worlds"
                }, o.createElement("div", {
                    className: "tw-relative tw-group"
                }, d && o.createElement(Ir, {
                    direction: "left",
                    onClick: function() {
                        var e;
                    ...
                    to: "/home/worlds",
                    className: " tw-px-3 tw-py-2 tw-rounded-xl tw-border-2 tw-border-solid tw-border-hr-grey tw-text-lighter-grey tw-text-sm tw-transition-colors "
                }, "Discover Worlds"))) : o.createElement(W, {
                    title: "Worlds"
                }, o.createElement("div", {
                    className: "tw-flex tw-items-center tw-justify-center tw-min-h-[100px]"
                }, o.createElement("p", {
            ...
            var qr = {
                ...
                Wr = function() {
                    var e, t, r, E, y = (0, re.wA)(),
                        ...
                        S = (0, Q.al)();
                    (0, o.useEffect)(function() {
                        "me" === C && null != _ && _.id && N("/home/user/".concat(null == _ ? void 0 : _.id))
                    }, [_, C]);
                    var O = (0, o.useMemo)(function() {
                            return C === (null == _ ? void 0 : _.id)
                        }, [C, _]),
                        M = (0, o.useState)("true" === I.get("settings")),
                        R = (0, l.A)(M, 2),
                        P = R[0],
                        F = R[1],
                        j = (0, o.useState)(!1),
                        ...
                        ue = ie.isError,
                        de = ie.isSuccess,
                        me = (ie.error, ie.isFetching),
                        pe = (0, m.M7)({
                            userId: C,
                            asSelf: O,
                            withGroupsAndWorlds: !0
                        }, {
                            skip: null === C || "me" === C
                        }),
                        fe = pe.data,
                        ...
                        Te = Ie.backgroundGradientBottom,
                        Se = Ie.backgroundGradientTop,
                        Oe = Ie.backgroundTemplateId,
                        Me = Ie.backgroundTextureId,
                        Re = Ie.themeIconColor,
                        Pe = Ie.themeButtonColor,
                        Fe = Ie.themeSubtextColor,
                        ...
                        Le = (0, b.A)().getCosmeticByTemplateId,
                        Ge = (0, o.useMemo)(function() {
                            var e = null == fe ? void 0 : fe.profileEffect;
                            return Le("profileEffect", e)
                        }, [null == fe ? void 0 : fe.profileEffect, Le]),
                        Be = (0, o.useMemo)(function() {
                            var e = null == fe ? void 0 : fe.iconFrame;
                            return Le("iconFrame", e)
                        }, [null == fe ? void 0 : fe.iconFrame, Le]),
                        Ue = (0, o.useMemo)(function() {
                            var e = null == fe ? void 0 : fe.nameplateEffect;
                            return Le("nameplateEffect", e)
                        }, [null == fe ? void 0 : fe.nameplateEffect, Le]),
                        De = (0, d.Yj)({
                            userId: C
                        }, {
                            skip: !C
                        ...
                        Ke = void 0 === He ? [] : He;
                    (0, o.useEffect)(function() {
                        if (O) return J(!1), void ne(!1);
                        if (ce) {
                            var e = oe.filter(function(e) {
                                return e.targetUserId === C
                            });
                            J(e.some(function(e) {
                                return "mute" === e.type
                    ...
                    }, [oe, O, C, ce]), (0, o.useEffect)(function() {
                        if (_e === i.N6.GRADIENT && Te && Se && y((0, Dr.IB)({
                                backgroundImage: "linear-gradient(to top, ".concat(Te, ", ").concat(Se, ")"),
                    ...
                    var Je = (0, o.useCallback)(function() {
                            return z(qr.GROUPS)
                        }, []),
                        Qe = (0, o.useCallback)(function() {
                            return z(qr.BADGES)
                        }, []),
                        et = (0, o.useCallback)(function() {
                            return z(qr.MUTUAL_FRIENDS)
                        }, []),
                        tt = (0, o.useCallback)(function() {
                            return z(qr.MUTUAL_GROUPS)
                        }, []),
                        rt = (0, o.useCallback)(function(e) {
                            return o.createElement(Ye, {
                                key: e.badgeId,
                                badge: e
                            })
                        }, []),
                        nt = (0, o.useCallback)(function(e) {
                            Y(e), z(qr.WORLDS)
                        }, []),
                        at = (0, o.useCallback)(function() {
                            z(null), Y(null)
                        }, []),
                        lt = (0, o.useCallback)(function(e) {
                            return o.createElement(v.A, {
                                key: e.groupId,
                                group: e
                            })
                        }, []),
                        ot = (0, o.useCallback)(function(e) {
                            return o.createElement(s.mI, {
                                key: e.id,
                                data: e,
                                contentType: "world",
                        ...
                        it = (0, o.useCallback)(function(e) {
                            return o.createElement(x.A, {
                                key: e.id,
                                userData: e
                            })
                        }, []),
                        st = (0, o.useMemo)(function() {
                            return Ve ? Ve.find(function(e) {
                    ...
                    var wt = (0, o.useMemo)(function() {
                        var e;
                        return e = {}, (0, a.A)(e, qr.BADGES, {
                            ...
                            title: "".concat(Ee, "'s Groups"),
                            items: Ve,
                            renderItem: lt,
                            isLoading: ze,
                            gridColumns: 4
                        }), (0, a.A)(e, qr.WORLDS, {
                            title: (null == X ? void 0 : X.displayName) || "Worlds",
                            items: (null == X ? void 0 : X.worlds) || [],
                            renderItem: ot,
                            gridColumns: 4
                        }), (0, a.A)(e, qr.MUTUAL_FRIENDS, {
                            title: "Mutual Friends",
                            items: Xe,
                            renderItem: ct,
                            renderListItem: it,
                            gridColumns: 4
                        }), (0, a.A)(e, qr.MUTUAL_GROUPS, {
                            title: "Mutual Groups",
                            items: Ke,
                            renderItem: lt,
                            renderListItem: lt,
                    ...
                    }, [Ne, Ee, Ve, ze, rt, lt, ot, ct, X, Xe, Ke]);
                    if (ue) return null;
                    ...
                    return o.createElement(o.Fragment, null, O && P && o.createElement(ur, {
                        userId: C,
                        isOpen: P,
                        cancelCallback: function() {
                            return F(!1)
                        ...
                        style: {
                            "--profile-button-color": null != Pe ? Pe : "#064b5c",
                            "--profile-icon-color": null != Re ? Re : "#6ae3f9",
                            "--profile-subtext-color": null != Fe ? Fe : "#A9A9A9"
                        }
                    }, o.createElement(s.Qc, null, de ? null == we ? void 0 : we.displayName : "User"), !O && G && o.createElement(yt, {
                        friendUserId: C,
                        isOpen: G,
                        cancelCallback: function() {
                            return B(!1)
                        ...
                        representingGroup: st,
                        isMuted: K,
                        isBlocked: te,
                        isLoading: me || ge,
                        onViewAllFriendsClick: et,
                        onViewAllGroupsClick: tt,
                        profileEffect: Ge,
                        profileEffectKey: C,
                        iconFrame: Be,
                        nameplateEffect: Ue
                        ...
                        userId: C,
                        userName: null == we ? void 0 : we.displayName,
                        onFolderClick: nt,
                        isCurrentUser: O
                    })), o.createElement("div", {
                        ...
                        badges: Ne,
                        onViewAllClick: Qe
                    }), O && o.createElement(Ze, {
                        avatarId: ke
                    }), o.createElement(gr, {
                        userId: C,
                        onViewAllClick: Je,
                        isCurrentUser: O
                    }))), o.createElement(hr, (0, n.A)({
                        isVisible: !(!V || S && [qr.MUTUAL_FRIENDS, qr.MUTUAL_GROUPS].includes(V)),
                        onClose: at
                    }, null !== (r = wt[V]) && void 0 !== r ? r : {
                        title: "",
                        items: [],
                        renderItem: function() {
                            return null
                        }
                    })), o.createElement(xr, (0, n.A)({
                        isVisible: !!V && S && [qr.MUTUAL_FRIENDS, qr.MUTUAL_GROUPS].includes(V),
                        onClose: at
                    }, null !== (E = wt[V]) && void 0 !== E ? E : {
                        title: "",
                        items: [],
        ...
        44877(e, t, r) {
            ...
            var n = r(89483).m.injectEndpoints({
                ...
                a = n.useGetInstanceQuery,
                l = n.useGetInstanceByShortNameQuery
        },
        29097(e, t, r) {
            e.exports = {
                srcSet: r.p + "912ec0ca96d1c103-89w.png 89w",
                images: [{
                    path: r.p + "912ec0ca96d1c103-89w.png",
                    width: 89,
                    height: 113
                }],
                src: r.p + "912ec0ca96d1c103-89w.png",
                toString: function() {
                    return r.p + "912ec0ca96d1c103-89w.png"
                },
                width: 89,
                height: 113
            }
        ...
        50976(e, t, r) {
            e.exports = {
                srcSet: r.p + "1cec4f93ff6b3477-76w.png 76w",
                images: [{
                    path: r.p + "1cec4f93ff6b3477-76w.png",
                    width: 76,
                    height: 98
                }],
                src: r.p + "1cec4f93ff6b3477-76w.png",
                toString: function() {
                    return r.p + "1cec4f93ff6b3477-76w.png"
                },
                width: 76,
                height: 98
            }
        ...
        34450(e, t, r) {
            "use strict";
            e.exports = r.p + "53f4092cfcb77e5217e639fd7a2012ff35100e4d9b6ed70707b47746bcb81c86.svg"
        }
    }
]);
