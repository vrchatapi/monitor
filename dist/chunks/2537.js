    ...
    [2537, 2874], {
        ...
        89468: (e, t) => {
            ...
            var r = "caret-up",
                n = [],
                i = "f0d8",
                o = "M182.6 137.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8l256 0c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-128-128z";
            t.DF = {
                prefix: "fas",
                iconName: r,
                icon: [320, 512, n, i, o]
                    ...
                    return (0, n.useEffect)((function() {
                        ...
                        return O.current = new IntersectionObserver((function(t) {
                                var r = t[0],
                                    ...
                                    h = void 0 !== o ? o : n > 0;
                                h = b > 0 ? n >= b : h, a < m.current.x && (d.horizontal = "left"), a > m.current.x && (d.horizontal = "right"), m.current.x = a, u < m.current.y && (d.vertical = "up"), u > m.current.y && (d.vertical = "down"), m.current.y = u;
                                var y = {
                                    entry: r,
                                    scrollDirection: d,
                                    observe: C,
                                ...
                                l && (void 0 !== p || w.current || (console.warn("💡 react-cool-inview: the browser doesn't support Intersection Observer v2, fallback to v1 behavior"), w.current = !0), void 0 !== p && (h = p)), h && !g.current && (f && N(), j.current && j.current(y)), !h && g.current && D.current && D.current(y), x.current && x.current(i({}, y, {
                                    inView: h
                                })), e && v({
                                    inView: h,
                                    scrollDirection: d,
        ...
        74300: (e, t, r) => {
            ...
            var v = function(e) {
                ...
                function s() {
                    ...
                    return y(b(e = a.call.apply(a, [this].concat(r))), "onClick", (function(t) {
                        var r = e.props,
                            n = r.text,
                            c = r.onCopy,
                            a = r.children,
        ...
        23138: (e, t, r) => {
            ...
            function v(e) {
                var t = e.className,
                    ...
                    w = e.children,
                    x = e.transition,
                    j = void 0 === x ? d(d({}, l.Z.defaultProps), {}, {
                        unmountOnExit: !0
                    }) : x,
                    D = e.fade,
                    P = void 0 === D || D,
        ...
        65706: (e, t, r) => {
                    ...
                    value: function() {
                        ...
                        return n.createElement(s.ZP, d({}, g, {
                            ...
                            var o = function(e) {
                                ...
                                s = (0, l.mx)(a()(c, i && "collapse-horizontal", o, u && "navbar-collapse"), f),
            ...
            N.propTypes = j, N.defaultProps = D;
            const C = N
        },
        30776: (e, t, r) => {
            "use strict";
            ...
            function d(e) {
                var t = e.className,
                    ...
                    d = void 0 === p ? "small" : p,
                    b = f(e, l),
                    h = (0, s.mx)(a()(t, !i && "form-text", !!c && "text-".concat(c)), r);
                    ...
                    return t = c, i = [{
                        ...
                        value: function() {
                            var e = this.props,
                                ...
                                i = e.tag,
                                o = void 0 === i ? "div" : i,
                                c = (0, l.CE)(this.props, Object.keys(y)),
