    ...
    [4109], {
        ...
        42295: (e, t, r) => {
            ...
            const F = function() {
                var e = (0, m.I0)(),
                    ...
                    N = O[0],
                    S = O[1],
                    C = (S.isError, S.error, d.useState(!1)),
                    j = (0, l.Z)(C, 2),
                    $ = j[0],
                    D = j[1],
                    P = d.useState({
                        ...
                        var e = (0, n.Z)(s().mark((function e(r) {
                            ...
                            return s().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (a = r.target.value, n = void 0 === a ? "" : a, z(k(k({}, M), {}, {
                                                value: n
                                            })), "" !== n) {
                                            e.next = 4;
                                            break
                ...
                return d.createElement(y.Z, null, d.createElement(h.$4, null, "Email Verification"), d.createElement("div", {
                    ...
                    onChange: J,
                    loading: M.checking
                }), M.value.includes("@") && M.error && d.createElement(_.bZ, {
                    role: "alert",
                    "aria-label": "Email Error"
                }, M.error), M.ok && d.createElement(h.II, {
                    type: "email",
                    id: "emailAgain",
                    inputMode: "email",
                    name: "emailAgain",
                ...
                }), M.ok && (q.ok ? d.createElement(h.II, {
                    type: "password",
                    id: "password",
                    name: "password",
                    className: "tw-mt-2 tw-w-full",
                ...
                }, "Emails do not match")), M.ok && q.ok && V && d.createElement(h.zx, {
                    onClick: function(e) {
                        e.preventDefault(), M.ok && q.ok && V && N({
                            userId: u.id,
                            email: M.value,
                            password: V
                        })
        ...
        83868: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (!t.ignore_max_length && e.length > b) return !1;
                var x = e.split("@"),
                    g = x.pop(),
                    v = g.toLowerCase();
                ...
                for (var F = t.allow_utf8_local_part ? w : f, O = h.split("."), N = 0; N < O.length; N++)
                    if (!F.test(O[N])) return !1;
...
//# sourceMappingURL=2e54ceb9e5461764279500267a2f0164116fe261bf9dd1b37d6aa070677c5325.js.map